...
export const t: Record<string, Record<EmailLang, string>> = {
  ...
  'recovery.text': {
    fr: "Nous avons reçu une demande de réinitialisation de votre mot de passe Ta'alam. Cliquez sur le bouton ci-dessous pour choisir un nouveau mot de passe.",
    en: "We received a request to reset your Ta'alam password. Click the button below to choose a new password.",
    ar: "تلقينا طلبًا لإعادة تعيين كلمة مرور تعلّم الخاصة بك. انقر على الزر أدناه لاختيار كلمة مرور جديدة.",
    nl: "We hebben een verzoek ontvangen om je Ta'alam-wachtwoord opnieuw in te stellen. Klik op de onderstaande knop om een nieuw wachtwoord te kiezen.",
    tr: "Ta'alam şifrenizi sıfırlamak için bir talep aldık. Yeni bir şifre seçmek için aşağıdaki düğmeye tıklayın.",
    ur: "ہمیں آپ کے تعلّم پاسورڈ ری سیٹ کرنے کی درخواست موصول ہوئی۔ نیا پاسورڈ منتخب کرنے کے لیے نیچے بٹن پر کلک کریں۔",
  },
  'recovery.button': {
