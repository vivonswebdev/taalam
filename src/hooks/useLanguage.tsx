...
const translations = {
  ...
  "mushaf.title": { fr: "Mushaf complet", en: "Full Mushaf", nl: "Volledige Mushaf", ar: "المصحف الكامل", tr: "Tam Mushaf", ur: "مکمل مصحف" },
  "mushaf.subtitle": { fr: "Lis le Coran page par page, comme dans le Mushaf.", en: "Read the Quran page by page, like in the Mushaf.", nl: "Lees de Koran pagina voor pagina, zoals in de Mushaf.", ar: "اقرأ القرآن صفحة بصفحة كما في المصحف.", tr: "Kur'an'ı sayfa sayfa oku, Mushaf'taki gibi.", ur: "مصحف کی طرح قرآن صفحہ بہ صفحہ پڑھیں۔" },
  ...
  "mushaf.settings": { fr: "Paramètres de lecture", en: "Reading settings", nl: "Leesinstellingen", ar: "إعدادات القراءة", tr: "Okuma ayarları", ur: "پڑھنے کی ترتیبات" },
