...
const translations = {
  ...
  "home.kidsSpace": { fr: "Espace enfants", en: "Kids Zone", nl: "Kinderhoek", ar: "ركن الأطفال", tr: "Çocuk Alanı", ur: "بچوں کا حصہ" },
  "home.kidsSpaceDesc": { fr: "Noorani, prière, 'Umra & Hajj, mosquées, quiz…", en: "Noorani, prayer, 'Umra & Hajj, mosques, quiz…", nl: "Noorani, gebed, 'Umra & Hadj, moskeeën, quiz…", ar: "النورانية، الصلاة، العمرة والحج، المساجد، الاختبارات…", tr: "Noorani, namaz, Umre & Hac, camiler, testler…", ur: "نورانی، نماز، عمرہ اور حج، مساجد، کوئز…" },
