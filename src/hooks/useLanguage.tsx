...
const translations = {
  ...
  "more.devine": { fr: "Devine qui suis-je ?", en: "Guess Who I Am?", nl: "Raad wie ik ben?", ar: "خمّن من أنا؟", tr: "Kim olduğumu tahmin et?", ur: "اندازہ لگاؤ میں کون ہوں؟" },
  "more.devineDesc": { fr: "Jeu style Akinator — Personnalités islamiques", en: "Akinator-style game — Islamic personalities", nl: "Akinator-stijl spel — Islamitische persoonlijkheden", ar: "لعبة بأسلوب أكيناتور — شخصيات إسلامية", tr: "Akinator tarzı oyun — İslami şahsiyetler", ur: "اکیناٹر طرز کا کھیل — اسلامی شخصیات" },
