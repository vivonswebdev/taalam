...
const translations = {
  ...
  "more.communityDesc": { fr: "Groupes et discussions", en: "Groups and discussions", nl: "Groepen en discussies", ar: "المجموعات والمناقشات", tr: "Gruplar ve tartışmalar", ur: "گروپس اور بحث" },
  "more.teacherDashboard": { fr: "Dashboard Professeur", en: "Teacher Dashboard", nl: "Docent Dashboard", ar: "لوحة المعلم", tr: "Öğretmen Paneli", ur: "استاد ڈیش بورڈ" },
  "more.teacherDashboardDesc": { fr: "Suivi des élèves", en: "Student tracking", nl: "Leerlingen volgen", ar: "متابعة الطلاب", tr: "Öğrenci takibi", ur: "طلباء کی نگرانی" },
  ...
  "more.notificationsDesc": { fr: "Rappels et alertes", en: "Reminders and alerts", nl: "Herinneringen en meldingen", ar: "التذكيرات والتنبيهات", tr: "Hatırlatmalar ve uyarılar", ur: "یاددہانی اور الرٹس" },
  ...
  "more.installAppDesc": { fr: "Ajouter à l'écran d'accueil", en: "Add to home screen", nl: "Toevoegen aan startscherm", ar: "إضافة إلى الشاشة الرئيسية", tr: "Ana ekrana ekle", ur: "ہوم اسکرین پر شامل کریں" },
  "more.helpFaq": { fr: "FAQ / Support", en: "FAQ / Support", nl: "FAQ / Ondersteuning", ar: "الأسئلة / الدعم", tr: "SSS / Destek", ur: "سوالات / سپورٹ" },
  "more.helpFaqDesc": { fr: "Aide et conditions", en: "Help and terms", nl: "Help en voorwaarden", ar: "المساعدة والشروط", tr: "Yardım ve koşullar", ur: "مدد اور شرائط" },
  "more.version": { fr: "Version", en: "Version", nl: "Versie", ar: "الإصدار", tr: "Sürüm", ur: "ورژن" },
  "more.athkar": { fr: "Athkar / Duas", en: "Athkar / Duas", nl: "Athkar / Duas", ar: "الأذكار / الأدعية", tr: "Zikirler / Dualar", ur: "اذکار / دعائیں" },
  "more.athkarDesc": { fr: "Invocations quotidiennes", en: "Daily supplications", nl: "Dagelijkse smeekbeden", ar: "الأدعية اليومية", tr: "Günlük dualar", ur: "روزانہ کی دعائیں" },
  "more.advancedListening": { fr: "Mode Écoute avancé", en: "Advanced Listening", nl: "Geavanceerd luisteren", ar: "الاستماع المتقدم", tr: "Gelişmiş dinleme", ur: "ایڈوانسڈ سننا" },
  "more.advancedListeningDesc": { fr: "Écoute structurée et quiz", en: "Structured listening & quiz", nl: "Gestructureerd luisteren & quiz", ar: "استماع منظم واختبار", tr: "Yapılandırılmış dinleme & test", ur: "منظم سننا اور کوئز" },
  "more.favoritesNotes": { fr: "Notes & Favoris", en: "Notes & Favorites", nl: "Notities & Favorieten", ar: "ملاحظات ومفضلات", tr: "Notlar & Favoriler", ur: "نوٹس اور پسندیدہ" },
  "more.favoritesNotesDesc": { fr: "Vos notes et ayat sauvegardées", en: "Your notes and saved verses", nl: "Je notities en opgeslagen verzen", ar: "ملاحظاتك وآياتك المحفوظة", tr: "Notlarınız ve kayıtlı ayetler", ur: "آپ کے نوٹس اور محفوظ آیات" },
  "more.recitation": { fr: "Récitation guidée", en: "Guided Recitation", nl: "Begeleide recitatie", ar: "تلاوة موجهة", tr: "Rehberli tilavet", ur: "رہنمائی والی تلاوت" },
  "more.recitationDesc": { fr: "Tarteel et correction IA", en: "Tarteel and AI correction", nl: "Tarteel en AI-correctie", ar: "ترتيل وتصحيح بالذكاء الاصطناعي", tr: "Tarteel ve yapay zeka düzeltmesi", ur: "ترتیل اور AI تصحیح" },
  "more.noorani": { fr: "Qaida Noorani", en: "Qaida Noorani", nl: "Qaida Noorani", ar: "القاعدة النورانية", tr: "Kaide Nuraniye", ur: "قاعدہ نورانی" },
  "more.nooraniDesc": { fr: "Apprends à lire l'arabe", en: "Learn to read Arabic", nl: "Leer Arabisch lezen", ar: "تعلم قراءة العربية", tr: "Arapça okumayı öğren", ur: "عربی پڑھنا سیکھیں" },
