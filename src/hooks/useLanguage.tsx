...
const translations = {
  ...
  "noorani.lesson5Title": { fr: "Tanwîn", en: "Tanween", nl: "Tanween", ar: "التنوين", tr: "Tenvin", ur: "تنوین" },
  "noorani.lesson5Desc": { fr: "Fathaïn, Dammaïn, Kasraïn", en: "Double vowels", nl: "Dubbele klinkers", ar: "التنوين بالفتح والضم والكسر", tr: "Çift sesli harfler", ur: "دوہری حرکات" },
  "noorani.lesson6Title": { fr: "Sukûn", en: "Sukoon", nl: "Sukoon", ar: "السكون", tr: "Sükun", ur: "سکون" },
  "noorani.lesson6Desc": { fr: "Lettres avec sukun pour apprendre l'arrêt", en: "Letters with sukoon to learn pausing", nl: "Letters met sukoon om pauzes te leren", ar: "حروف بسكون لتعلم الوقف", tr: "Durağı öğrenmek için sükun harfleri", ur: "وقف سیکھنے کے لیے سکون والے حروف" },
