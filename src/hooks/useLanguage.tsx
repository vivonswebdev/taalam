...
const translations = {
  ...
  "dictation.preListenHint": { fr: "Écoute d'abord tous les versets avant de réciter. C'est important pour bien mémoriser !", en: "Listen to all verses first before reciting. It helps memorize better!", nl: "Luister eerst naar alle verzen voor je reciteert. Het helpt bij het onthouden!", ar: "استمع لجميع الآيات أولاً قبل التلاوة. هذا مهم للحفظ!", tr: "Okumadan önce tüm ayetleri dinle. Ezberlemeye yardımcı olur!", ur: "تلاوت سے پہلے تمام آیات سنیں۔ حفظ میں مدد ملتی ہے!" },
  "dictation.listenFirstHint": { fr: "Écoute les versets d'abord avant de commencer la dictée", en: "Listen to the verses first before starting dictation", nl: "Luister eerst naar de verzen voordat je begint", ar: "استمع للآيات أولاً قبل بدء الإملاء", tr: "Dikte başlamadan önce ayetleri dinle", ur: "ڈکٹیشن شروع کرنے سے پہلے آیات سنیں" },
