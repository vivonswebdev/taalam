...
const translations = {
  ...
  "reading.phonetic": { fr: "Phonétique (translittération)", en: "Phonetic (transliteration)", nl: "Fonetisch (transliteratie)", ar: "صوتي (نقل حرفي)", tr: "Fonetik (transliterasyon)", ur: "صوتی (نقل حرفی)" },
  "reading.showTranslation": { fr: "Afficher la traduction", en: "Show translation", nl: "Vertaling tonen", ar: "عرض الترجمة", tr: "Çeviriyi göster", ur: "ترجمہ دکھائیں" },
  "reading.translationEdition": { fr: "Édition de traduction", en: "Translation edition", nl: "Vertaling editie", ar: "طبعة الترجمة", tr: "Çeviri baskısı", ur: "ترجمہ ایڈیشن" },
  ...
  "noorani.lesson9Title": { fr: "Madd – Voyelles longues", en: "Madd – Long vowels", nl: "Madd – Lange klinkers", ar: "المدّ – الحركات الطويلة", tr: "Medd – Uzun sesli harfler", ur: "مدّ – لمبی حرکات" },
  "noorani.lesson9Desc": { fr: "Apprends les sons longs avec Alif, Waw et Ya", en: "Learn long sounds with Alif, Waw and Ya", nl: "Leer lange klanken met Alif, Waw en Ya", ar: "تعلّم الأصوات الطويلة مع ألف وواو وياء", tr: "Elif, Vav ve Ya ile uzun sesleri öğren", ur: "الف، واؤ اور یاء کے ساتھ لمبی آوازیں سیکھیں" },
  "noorani.lesson10Title": { fr: "Madd dans les mots", en: "Madd in words", nl: "Madd in woorden", ar: "المدّ في الكلمات", tr: "Kelimelerde Medd", ur: "الفاظ میں مدّ" },
  "noorani.lesson10Desc": { fr: "Reconnais les voyelles longues dans les mots", en: "Recognize long vowels in words", nl: "Herken lange klinkers in woorden", ar: "تعرّف على الحركات الطويلة في الكلمات", tr: "Kelimelerdeki uzun seslileri tanı", ur: "الفاظ میں لمبی حرکات پہچانیں" },
  "noorani.lesson11Title": { fr: "Shaddah – Lettres doublées", en: "Shaddah – Doubled letters", nl: "Shaddah – Verdubbelde letters", ar: "الشدّة – الحروف المضعّفة", tr: "Şedde – Çift harfler", ur: "شدّہ – دوگنے حروف" },
  "noorani.lesson11Desc": { fr: "Apprends à reconnaître le signe de doublement", en: "Learn to recognize the doubling sign", nl: "Leer het verdubbelingsteken herkennen", ar: "تعلّم التعرف على علامة التضعيف", tr: "İkizleme işaretini tanımayı öğren", ur: "دوگنے کی علامت پہچاننا سیکھیں" },
  "noorani.lesson12Title": { fr: "Shaddah dans les mots", en: "Shaddah in words", nl: "Shaddah in woorden", ar: "الشدّة في الكلمات", tr: "Kelimelerde Şedde", ur: "الفاظ میں شدّہ" },
  "noorani.lesson12Desc": { fr: "Pratique le shaddah dans des mots courants", en: "Practice shaddah in common words", nl: "Oefen shaddah in veelgebruikte woorden", ar: "تدرّب على الشدّة في كلمات شائعة", tr: "Yaygın kelimelerde şedde pratik yap", ur: "عام الفاظ میں شدّہ کی مشق کریں" },
  "noorani.lesson13Title": { fr: "Formes des lettres", en: "Letter forms", nl: "Lettervormen", ar: "أشكال الحروف", tr: "Harf şekilleri", ur: "حروف کی شکلیں" },
  "noorani.lesson13Desc": { fr: "Début, milieu et fin : les 3 formes", en: "Beginning, middle and end: the 3 forms", nl: "Begin, midden en einde: de 3 vormen", ar: "بداية ووسط ونهاية: الأشكال الثلاثة", tr: "Başlangıç, orta ve son: 3 biçim", ur: "شروع، درمیان اور آخر: 3 شکلیں" },
  "noorani.lesson14Title": { fr: "Lam-Alif", en: "Lam-Alif", nl: "Lam-Alif", ar: "لام ألف", tr: "Lam-Elif", ur: "لام الف" },
  "noorani.lesson14Desc": { fr: "Combinaisons spéciales Lam + Alif", en: "Special Lam + Alif combinations", nl: "Speciale Lam + Alif combinaties", ar: "تركيبات لام ألف الخاصة", tr: "Özel Lam + Elif birleşimleri", ur: "لام + الف کے خاص جوڑ" },
  "noorani.lesson15Title": { fr: "Al solaire et lunaire", en: "Solar and lunar Al", nl: "Zonne- en maan-Al", ar: "أل الشمسية والقمرية", tr: "Güneş ve ay elifi", ur: "شمسی اور قمری الف لام" },
  "noorani.lesson15Desc": { fr: "Quand le Lam se prononce ou s'assimile", en: "When Lam is pronounced or assimilated", nl: "Wanneer Lam wordt uitgesproken of geassimileerd", ar: "متى يُنطق اللام ومتى يُدغم", tr: "Lam ne zaman okunur, ne zaman yutulur", ur: "لام کب پڑھا جائے اور کب ادغام ہو" },
  "noorani.lesson16Title": { fr: "Signes d'arrêt (Waqf)", en: "Stop signs (Waqf)", nl: "Stoptekens (Waqf)", ar: "علامات الوقف", tr: "Durma işaretleri (Vakıf)", ur: "وقف کی علامات" },
  "noorani.lesson16Desc": { fr: "Apprends les pauses et arrêts du Coran", en: "Learn Quranic pauses and stops", nl: "Leer de pauzes en stops van de Koran", ar: "تعلّم الوقف والابتداء في القرآن", tr: "Kur'an'daki durakları öğren", ur: "قرآن کے وقف اور ابتداء سیکھیں" },
  "noorani.lesson17Title": { fr: "Lire la Fâtiha", en: "Read Al-Fâtiha", nl: "Lees Al-Fâtiha", ar: "قراءة الفاتحة", tr: "Fâtiha'yı oku", ur: "سورۃ الفاتحہ پڑھیں" },
  "noorani.lesson17Desc": { fr: "Applique tout ce que tu as appris sur la sourate 1", en: "Apply everything you learned on Surah 1", nl: "Pas alles toe wat je hebt geleerd op soera 1", ar: "طبّق كل ما تعلمته على سورة الفاتحة", tr: "Öğrendiğin her şeyi 1. sure üzerinde uygula", ur: "جو سیکھا وہ سورۃ الفاتحہ پر لاگو کریں" },
   ...
   "noorani.expert": { fr: "Expert", en: "Expert", nl: "Expert", ar: "خبير", tr: "Uzman", ur: "ماہر" },
   "noorani.master": { fr: "Maître", en: "Master", nl: "Meester", ar: "متمكّن", tr: "Usta", ur: "ماسٹر" },
   "noorani.levelProgress": { fr: "terminé", en: "completed", nl: "voltooid", ar: "مكتمل", tr: "tamamlandı", ur: "مکمل" },
   "noorani.lesson18Title": { fr: "Qalqalah – Lettres rebondissantes", en: "Qalqalah – Bouncing letters", nl: "Qalqalah – Stuiterende letters", ar: "القلقلة – الحروف المرتدة", tr: "Kalkale – Zıplayan harfler", ur: "قلقلہ – اچھلنے والے حروف" },
   "noorani.lesson18Desc": { fr: "Les 5 lettres qui rebondissent au sukûn (ق ط ب ج د)", en: "The 5 letters that bounce at sukūn (ق ط ب ج د)", nl: "De 5 letters die stuiten bij sukūn (ق ط ب ج د)", ar: "الحروف الخمسة التي ترتد عند السكون (ق ط ب ج د)", tr: "Sükunda zıplayan 5 harf (ق ط ب ج د)", ur: "سکون پر اچھلنے والے 5 حروف (ق ط ب ج د)" },
   "noorani.lesson19Title": { fr: "Noun Sâkinah – 4 règles", en: "Noon Saakinah – 4 rules", nl: "Noon Saakinah – 4 regels", ar: "النون الساكنة – 4 أحكام", tr: "Nûn-u Sâkine – 4 kural", ur: "نون ساکنہ – 4 احکام" },
   "noorani.lesson19Desc": { fr: "Iẓhār, Idghām, Iqlāb et Ikhfā'", en: "Iẓhār, Idghām, Iqlāb and Ikhfā'", nl: "Iẓhār, Idghām, Iqlāb en Ikhfā'", ar: "الإظهار والإدغام والإقلاب والإخفاء", tr: "İzhâr, İdgâm, İklâb ve İhfâ", ur: "اظہار، ادغام، اقلاب اور اخفاء" },
   "noorani.lesson20Title": { fr: "Mîm Sâkinah", en: "Meem Saakinah", nl: "Meem Saakinah", ar: "الميم الساكنة", tr: "Mîm-i Sâkine", ur: "میم ساکنہ" },
   "noorani.lesson20Desc": { fr: "Les 3 règles du Mîm au sukûn", en: "The 3 rules of Meem at sukūn", nl: "De 3 regels van Meem bij sukūn", ar: "أحكام الميم الساكنة الثلاثة", tr: "Mîm-i Sâkine'nin 3 kuralı", ur: "میم ساکنہ کے 3 احکام" },
   "noorani.lesson21Title": { fr: "Les types de Madd", en: "Types of Madd", nl: "Soorten Madd", ar: "أنواع المدود", tr: "Medd türleri", ur: "مد کی اقسام" },
   "noorani.lesson21Desc": { fr: "Madd naturel, connecté, séparé et obligatoire", en: "Natural, connected, separated and obligatory Madd", nl: "Natuurlijke, verbonden, gescheiden en verplichte Madd", ar: "المد الطبيعي والمتصل والمنفصل واللازم", tr: "Tabiî, muttasıl, munfasıl ve lâzım medd", ur: "طبعی، متصل، منفصل اور لازم مد" },
   "noorani.lesson22Title": { fr: "Tafkhîm et Tarqîq", en: "Tafkhīm and Tarqīq", nl: "Tafkhīm en Tarqīq", ar: "التفخيم والترقيق", tr: "Tefhîm ve Terkîk", ur: "تفخیم اور ترقیق" },
   "noorani.lesson22Desc": { fr: "Lettres lourdes et légères en Tajwîd", en: "Heavy and light letters in Tajweed", nl: "Zware en lichte letters in Tajweed", ar: "الحروف المفخّمة والمرقّقة في التجويد", tr: "Tecvidde kalın ve ince harfler", ur: "تجوید میں بھاری اور ہلکے حروف" },
   "noorani.lesson23Title": { fr: "Lire Âyat al-Kursî", en: "Read Āyat al-Kursī", nl: "Lees Āyat al-Kursī", ar: "قراءة آية الكرسي", tr: "Âyete'l-Kürsî'yi oku", ur: "آیۃ الکرسی پڑھیں" },
   "noorani.lesson23Desc": { fr: "Applique le tajwîd sur le verset du Trône", en: "Apply tajweed on the Throne verse", nl: "Pas tajweed toe op het Troonvers", ar: "طبّق التجويد على آية الكرسي", tr: "Kürsî ayetinde tecvid uygula", ur: "آیۃ الکرسی پر تجوید لاگو کریں" },
   "noorani.lesson24Title": { fr: "Lire les 3 Qul", en: "Read the 3 Qul", nl: "Lees de 3 Qul", ar: "قراءة المعوذات الثلاث", tr: "3 Kul suresini oku", ur: "تین قل پڑھیں" },
   "noorani.lesson24Desc": { fr: "Al-Ikhlâs, Al-Falaq et An-Nâs avec tajwîd", en: "Al-Ikhlās, Al-Falaq and An-Nās with tajweed", nl: "Al-Ikhlās, Al-Falaq en An-Nās met tajweed", ar: "الإخلاص والفلق والناس بالتجويد", tr: "İhlâs, Felâk ve Nâs tecvidli", ur: "سورۃ الاخلاص، الفلق اور الناس تجوید کے ساتھ" },
   "noorani.lesson25Title": { fr: "Lire Sourate Al-Qadr", en: "Read Surah Al-Qadr", nl: "Lees Soera Al-Qadr", ar: "قراءة سورة القدر", tr: "Kadir Suresi'ni oku", ur: "سورۃ القدر پڑھیں" },
   "noorani.lesson25Desc": { fr: "Lecture complète de la sourate 97 avec tajwîd", en: "Full reading of Surah 97 with tajweed", nl: "Volledige lezing van soera 97 met tajweed", ar: "قراءة كاملة لسورة القدر بالتجويد", tr: "97. surenin tecvidli tam okuyuşu", ur: "سورۃ القدر کی مکمل تجوید کے ساتھ تلاوت" },
  ...
  "more.devine": { fr: "Kashif كاشف", en: "Kashif كاشف", nl: "Kashif كاشف", ar: "كاشف", tr: "Kashif كاشف", ur: "کاشف" },
  "more.devineDesc": { fr: "Devine la personnalité islamique", en: "Guess the Islamic personality", nl: "Raad de islamitische persoonlijkheid", ar: "اكتشف الشخصية الإسلامية", tr: "İslami şahsiyeti tahmin et", ur: "اسلامی شخصیت کا اندازہ لگائیں" },
  ...
  "mushaf.styleImmersive": { fr: "Immersif", en: "Immersive", nl: "Meeslepend", ar: "غامر", tr: "Sürükleyici", ur: "عمیق" },
  "mushaf.styleFullscreen": { fr: "Plein écran", en: "Fullscreen", nl: "Volledig scherm", ar: "شاشة كاملة", tr: "Tam ekran", ur: "فل سکرین" },
  "mushaf.styleMushaf": { fr: "Mushaf (livre)", en: "Mushaf (book)", nl: "Mushaf (boek)", ar: "المصحف (كتاب)", tr: "Mushaf (kitap)", ur: "مصحف (کتاب)" },
  "mushaf.zoomText": { fr: "Taille du texte", en: "Text size", nl: "Tekstgrootte", ar: "حجم الخط", tr: "Metin boyutu", ur: "متن کا سائز" },
  ...
  "mushaf.downloadTitle": { fr: "Télécharger le Coran complet", en: "Download the full Quran", nl: "Download de volledige Koran", ar: "تحميل القرآن الكريم كاملاً", tr: "Tam Kur'an'ı indir", ur: "مکمل قرآن ڈاؤن لوڈ کریں" },
  "mushaf.downloadDesc": { fr: "Téléchargez les 604 pages (~15 MB) pour une lecture fluide hors ligne avec tajwid, traduction et audio.", en: "Download all 604 pages (~15 MB) for smooth offline reading with tajwid, translation and audio.", nl: "Download alle 604 pagina's (~15 MB) voor soepel offline lezen met tajwid, vertaling en audio.", ar: "حمّل الـ 604 صفحة (~15 ميجابايت) لقراءة سلسة بدون إنترنت مع التجويد والترجمة والصوت.", tr: "604 sayfayı (~15 MB) indirin: tecvid, çeviri ve sesle çevrimdışı okuyun.", ur: "تجوید، ترجمہ اور آڈیو کے ساتھ آف لائن پڑھنے کے لیے تمام 604 صفحات (~15 MB) ڈاؤن لوڈ کریں۔" },
  "mushaf.downloadNow": { fr: "Télécharger maintenant", en: "Download now", nl: "Nu downloaden", ar: "تحميل الآن", tr: "Şimdi indir", ur: "ابھی ڈاؤن لوڈ کریں" },
  "mushaf.skipDownload": { fr: "Passer (lecture en ligne)", en: "Skip (online reading)", nl: "Overslaan (online lezen)", ar: "تخطي (قراءة عبر الإنترنت)", tr: "Atla (çevrimiçi okuma)", ur: "چھوڑیں (آن لائن پڑھنا)" },
  "mushaf.downloadLater": { fr: "Vous pourrez télécharger plus tard depuis les Paramètres", en: "You can download later from Settings", nl: "U kunt later downloaden vanuit Instellingen", ar: "يمكنك التحميل لاحقاً من الإعدادات", tr: "Daha sonra Ayarlar'dan indirebilirsiniz", ur: "آپ بعد میں سیٹنگز سے ڈاؤن لوڈ کر سکتے ہیں" },
  "mushaf.downloadComplete": { fr: "✅ Coran téléchargé !", en: "✅ Quran downloaded!", nl: "✅ Koran gedownload!", ar: "✅ تم تحميل القرآن!", tr: "✅ Kur'an indirildi!", ur: "✅ قرآن ڈاؤن لوڈ ہو گیا!" },
  "mushaf.downloadCompleteDesc": { fr: "604 pages prêtes hors ligne", en: "604 pages ready offline", nl: "604 pagina's klaar voor offline", ar: "604 صفحة جاهزة بدون إنترنت", tr: "604 sayfa çevrimdışı hazır", ur: "604 صفحات آف لائن تیار" },
  "mushaf.downloadError": { fr: "❌ Erreur de téléchargement", en: "❌ Download error", nl: "❌ Downloadfout", ar: "❌ خطأ في التحميل", tr: "❌ İndirme hatası", ur: "❌ ڈاؤن لوڈ میں خرابی" },
  "mushaf.downloadErrorDesc": { fr: "Vérifiez votre connexion", en: "Check your connection", nl: "Controleer uw verbinding", ar: "تحقق من اتصالك", tr: "Bağlantınızı kontrol edin", ur: "اپنا کنکشن چیک کریں" },
  "mushaf.downloading": { fr: "Téléchargement en cours...", en: "Downloading...", nl: "Downloaden...", ar: "جاري التحميل...", tr: "İndiriliyor...", ur: "ڈاؤن لوڈ ہو رہا ہے..." },
  "mushaf.offlineError": { fr: "Page non disponible hors ligne", en: "Page not available offline", nl: "Pagina niet offline beschikbaar", ar: "الصفحة غير متاحة بدون إنترنت", tr: "Sayfa çevrimdışı kullanılamıyor", ur: "صفحہ آف لائن دستیاب نہیں" },
  "mushaf.loadError": { fr: "Erreur de chargement", en: "Loading error", nl: "Laadfout", ar: "خطأ في التحميل", tr: "Yükleme hatası", ur: "لوڈنگ میں خرابی" },
  "mushaf.tajwidColored": { fr: "Tajwid coloré", en: "Colored Tajwid", nl: "Gekleurde Tajwid", ar: "تجويد ملوّن", tr: "Renkli Tecvid", ur: "رنگین تجوید" },
  "mushaf.pinchToZoom": { fr: "Pincez pour zoomer sur mobile", en: "Pinch to zoom on mobile", nl: "Knijp om te zoomen op mobiel", ar: "اضغط للتكبير على الهاتف", tr: "Mobilde yakınlaştırmak için sıkıştırın", ur: "موبائل پر زوم کرنے کے لیے پنچ کریں" },
  "mushaf.category": { fr: "Catégorie", en: "Category", nl: "Categorie", ar: "الفئة", tr: "Kategori", ur: "زمرہ" },
  "mushaf.bookmarkColor": { fr: "Couleur du signet", en: "Bookmark color", nl: "Bladwijzerkleur", ar: "لون العلامة", tr: "Yer imi rengi", ur: "بُک مارک رنگ" },
  "mushaf.personalNote": { fr: "Note personnelle", en: "Personal note", nl: "Persoonlijke notitie", ar: "ملاحظة شخصية", tr: "Kişisel not", ur: "ذاتی نوٹ" },
  "mushaf.notePlaceholder": { fr: "Vos réflexions sur ce verset...", en: "Your thoughts on this verse...", nl: "Uw gedachten over dit vers...", ar: "أفكارك حول هذه الآية...", tr: "Bu ayet hakkındaki düşünceleriniz...", ur: "اس آیت کے بارے میں آپ کے خیالات..." },
  "mushaf.addTag": { fr: "Ajouter un tag...", en: "Add a tag...", nl: "Tag toevoegen...", ar: "أضف وسماً...", tr: "Etiket ekle...", ur: "ٹیگ شامل کریں..." },
  "mushaf.changeEdition": { fr: "Changer de Mushaf", en: "Change Mushaf", nl: "Mushaf Wijzigen", ar: "تغيير المصحف", tr: "Mushaf Değiştir", ur: "مصحف تبدیل کریں" },
  "mushaf.editionSubtitle": { fr: "Choisissez l'édition du Coran que vous souhaitez lire.", en: "Choose the Quran edition you want to read.", nl: "Kies de Koran-editie die je wilt lezen.", ar: "اختر نسخة القرآن التي تريد قراءتها.", tr: "Okumak istediğiniz Kuran baskısını seçin.", ur: "وہ قرآنی ایڈیشن منتخب کریں جو آپ پڑھنا چاہتے ہیں۔" },
  "mushaf.confirmEdition": { fr: "Confirmer le changement", en: "Confirm Change", nl: "Wijziging Bevestigen", ar: "تأكيد التغيير", tr: "Değişikliği Onayla", ur: "تبدیلی کی تصدیق کریں" },
  "mushaf.currentEdition": { fr: "Édition actuelle", en: "Current Edition", nl: "Huidige Editie", ar: "النسخة الحالية", tr: "Mevcut Baskı", ur: "موجودہ ایڈیشن" },
  "mushaf.editionChanged": { fr: "Mushaf changé", en: "Mushaf Changed", nl: "Mushaf Gewijzigd", ar: "تم تغيير المصحف", tr: "Mushaf Değiştirildi", ur: "مصحف تبدیل ہو گیا" },
  "mushaf.editionDescription": { fr: "Les pages se chargeront avec la nouvelle édition", en: "Pages will load with the new edition", nl: "Pagina's worden geladen met de nieuwe editie", ar: "سيتم تحميل الصفحات بالنسخة الجديدة", tr: "Sayfalar yeni baskı ile yüklenecek", ur: "صفحات نئے ایڈیشن کے ساتھ لوڈ ہوں گے" },
  "mushaf.imagesNotAvailable": { fr: "Images non disponibles", en: "Images Not Available", nl: "Afbeeldingen Niet Beschikbaar", ar: "الصور غير متوفرة", tr: "Görseller Mevcut Değil", ur: "تصاویر دستیاب نہیں" },
  "mushaf.imagesNotAvailableDesc": { fr: "Cette édition n'a pas encore d'images. Utilisez le mode Texte avec Tajwid.", en: "This edition doesn't have images yet. Use Text mode with Tajweed.", nl: "Deze editie heeft nog geen afbeeldingen. Gebruik Tekstmodus met Tajweed.", ar: "هذه النسخة لا تحتوي على صور بعد. استخدم وضع النص مع التجويد.", tr: "Bu baskının henüz görselleri yok. Tecvid ile Metin modunu kullanın.", ur: "اس ایڈیشن میں ابھی تصاویر نہیں ہیں۔ تجوید کے ساتھ ٹیکسٹ موڈ استعمال کریں۔" },
  ...
  "home.signupTitle": { fr: "Créez votre compte gratuit", en: "Create your free account", nl: "Maak je gratis account", ar: "أنشئ حسابك المجاني", tr: "Ücretsiz hesabınızı oluşturun", ur: "اپنا مفت اکاؤنٹ بنائیں" },
  "home.signupDesc": { fr: "Sauvegardez votre progression, rejoignez des classes et débloquez toutes les fonctionnalités.", en: "Save your progress, join classes and unlock all features.", nl: "Sla je voortgang op, neem deel aan klassen en ontgrendel alle functies.", ar: "احفظ تقدمك، انضم إلى الفصول وافتح جميع الميزات.", tr: "İlerlemenizi kaydedin, sınıflara katılın ve tüm özelliklerin kilidini açın.", ur: "اپنی پیشرفت محفوظ کریں، کلاسز میں شامل ہوں اور تمام خصوصیات کھولیں۔" },
  "home.signupBtn": { fr: "S'inscrire", en: "Sign up", nl: "Registreren", ar: "التسجيل", tr: "Kaydol", ur: "سائن اپ" },
  ...
  // ═══ Tarteel Offline ═══
  "tarteelOffline.title": { fr: "Tarteel Hors Ligne", en: "Tarteel Offline", nl: "Tarteel Offline", ar: "ترتيل بدون إنترنت", tr: "Çevrimdışı Tertil", ur: "آف لائن ترتیل" },
  "tarteelOffline.offlineBadge": { fr: "Hors ligne", en: "Offline", nl: "Offline", ar: "بدون إنترنت", tr: "Çevrimdışı", ur: "آف لائن" },
  "tarteelOffline.readyMsg": { fr: "Appuyez sur le micro et récitez un verset", en: "Tap the mic and recite a verse", nl: "Tik op de microfoon en reciteer een vers", ar: "اضغط على الميكروفون واتلُ آية", tr: "Mikrofona dokunun ve bir ayet okuyun", ur: "مائیک پر ٹیپ کریں اور آیت پڑھیں" },
  "tarteelOffline.recording": { fr: "Enregistrement en cours...", en: "Recording...", nl: "Opname bezig...", ar: "جاري التسجيل...", tr: "Kayıt yapılıyor...", ur: "ریکارڈنگ جاری ہے..." },
  "tarteelOffline.processing": { fr: "Analyse en cours...", en: "Analyzing...", nl: "Analyseren...", ar: "جاري التحليل...", tr: "Analiz ediliyor...", ur: "تجزیہ جاری ہے..." },
  "tarteelOffline.verseFound": { fr: "Verset identifié :", en: "Verse identified:", nl: "Vers geïdentificeerd:", ar: "الآية المحددة:", tr: "Tanımlanan ayet:", ur: "شناخت شدہ آیت:" },
  "tarteelOffline.surah": { fr: "Sourate", en: "Surah", nl: "Soera", ar: "سورة", tr: "Sure", ur: "سورۃ" },
  "tarteelOffline.ayah": { fr: "Ayah", en: "Ayah", nl: "Ayah", ar: "آية", tr: "Ayet", ur: "آیت" },
  "tarteelOffline.accuracy": { fr: "Précision", en: "Accuracy", nl: "Nauwkeurigheid", ar: "الدقة", tr: "Doğruluk", ur: "درستگی" },
  "tarteelOffline.excellent": { fr: "Excellente récitation !", en: "Excellent recitation!", nl: "Uitstekende recitatie!", ar: "تلاوة ممتازة!", tr: "Mükemmel okuma!", ur: "بہترین تلاوت!" },
  "tarteelOffline.retry": { fr: "Réessayer", en: "Retry", nl: "Opnieuw", ar: "إعادة", tr: "Tekrar", ur: "دوبارہ" },
  "tarteelOffline.history": { fr: "Historique récent", en: "Recent history", nl: "Recente geschiedenis", ar: "السجل الأخير", tr: "Son geçmiş", ur: "حالیہ تاریخ" },
  "tarteelOffline.privacyNote": { fr: "100% hors ligne — aucune donnée envoyée", en: "100% offline — no data sent", nl: "100% offline — geen data verzonden", ar: "100% بدون إنترنت — لا يتم إرسال بيانات", tr: "100% çevrimdışı — veri gönderilmez", ur: "100% آف لائن — کوئی ڈیٹا نہیں بھیجا جاتا" },
  "tarteelOffline.instructions": { fr: "Récitez clairement un verset du Coran.", en: "Clearly recite a Quran verse.", nl: "Reciteer duidelijk een Koranvers.", ar: "اتلُ آية من القرآن بوضوح.", tr: "Bir Kur'an ayetini net okuyun.", ur: "قرآن کی آیت واضح طور پر پڑھیں۔" },
  "tarteelOffline.modeTitle": { fr: "Mode Offline", en: "Offline Mode", nl: "Offline Modus", ar: "الوضع بدون إنترنت", tr: "Çevrimdışı Mod", ur: "آف لائن موڈ" },
  "tarteelOffline.modeDesc": { fr: "Reconnaissance vocale 100% hors ligne.", en: "100% offline voice recognition.", nl: "100% offline spraakherkenning.", ar: "التعرف الصوتي 100% بدون إنترنت.", tr: "100% çevrimdışı ses tanıma.", ur: "100% آف لائن آواز کی شناخت۔" },
  "tarteelOffline.featureOffline": { fr: "Fonctionne sans internet", en: "Works without internet", nl: "Werkt zonder internet", ar: "يعمل بدون إنترنت", tr: "İnternetsiz çalışır", ur: "انٹرنیٹ کے بغیر کام کرتا ہے" },
  "tarteelOffline.featurePrivacy": { fr: "Données privées", en: "Private data", nl: "Privégegevens", ar: "بيانات خاصة", tr: "Özel veriler", ur: "نجی ڈیٹا" },
  "tarteelOffline.featureAllQuran": { fr: "Tout le Coran (6236 versets)", en: "Full Quran (6236 verses)", nl: "Volledige Koran (6236 verzen)", ar: "القرآن كاملاً (6236 آية)", tr: "Tam Kur'an (6236 ayet)", ur: "مکمل قرآن (6236 آیات)" },
  "tarteelOffline.selectVerse": { fr: "Choisir un verset à réciter", en: "Choose a verse to recite", nl: "Kies een vers om te reciteren", ar: "اختر آية للتلاوة", tr: "Okuyacağınız ayeti seçin", ur: "تلاوت کے لیے آیت منتخب کریں" },
  "tarteelOffline.selectSurah": { fr: "Sourate", en: "Surah", nl: "Soera", ar: "سورة", tr: "Sure", ur: "سورۃ" },
  "tarteelOffline.selectAyah": { fr: "Ayah", en: "Ayah", nl: "Ayah", ar: "آية", tr: "Ayet", ur: "آیت" },
  "tarteelOffline.expectedVerse": { fr: "Verset attendu", en: "Expected verse", nl: "Verwacht vers", ar: "الآية المتوقعة", tr: "Beklenen ayet", ur: "متوقع آیت" },
  "tarteelOffline.detectedVerse": { fr: "Verset détecté", en: "Detected verse", nl: "Gedetecteerd vers", ar: "الآية المكتشفة", tr: "Tespit edilen ayet", ur: "شناخت شدہ آیت" },
  "tarteelOffline.exactMatch": { fr: "✅ Correspondance exacte !", en: "✅ Exact match!", nl: "✅ Exacte overeenkomst!", ar: "✅ تطابق تام!", tr: "✅ Tam eşleşme!", ur: "✅ بالکل درست!" },
  "tarteelOffline.differentVerse": { fr: "⚠️ Verset différent détecté", en: "⚠️ Different verse detected", nl: "⚠️ Ander vers gedetecteerd", ar: "⚠️ تم اكتشاف آية مختلفة", tr: "⚠️ Farklı ayet tespit edildi", ur: "⚠️ مختلف آیت کا پتہ چلا" },
  "tarteelOffline.noVerseText": { fr: "Texte non disponible pour cette sourate (sourates 1-10 uniquement)", en: "Text not available for this surah (surahs 1-10 only)", nl: "Tekst niet beschikbaar voor deze soera (soera 1-10 alleen)", ar: "النص غير متاح لهذه السورة (السور 1-10 فقط)", tr: "Bu sure için metin mevcut değil (yalnızca 1-10)", ur: "اس سورۃ کا متن دستیاب نہیں (صرف سورۃ 1-10)" },
  "tarteelOffline.liveTranscription": { fr: "Reconnaissance en direct...", en: "Live transcription...", nl: "Live transcriptie...", ar: "التعرف المباشر...", tr: "Canlı tanıma...", ur: "براہ راست شناخت..." },
  "tarteelOffline.wordsLabel": { fr: "mots", en: "words", nl: "woorden", ar: "كلمات", tr: "kelime", ur: "الفاظ" },
  "tarteelOffline.challengeMode": { fr: "Mode Compétition", en: "Challenge Mode", nl: "Uitdagingsmodus", ar: "وضع التحدي", tr: "Yarışma Modu", ur: "چیلنج موڈ" },
  "tarteelOffline.challengeModeDesc": { fr: "Cache le texte pour tester ta mémoire", en: "Hide text to test your memory", nl: "Verberg tekst om je geheugen te testen", ar: "إخفاء النص لاختبار حفظك", tr: "Hafızanı test etmek için metni gizle", ur: "یادداشت جانچنے کے لیے متن چھپائیں" },
  "tarteelOffline.textHidden": { fr: "Texte masqué", en: "Text hidden", nl: "Tekst verborgen", ar: "النص مخفي", tr: "Metin gizli", ur: "متن پوشیدہ" },
  "tarteelOffline.showHint": { fr: "Voir un indice", en: "Show hint", nl: "Toon hint", ar: "إظهار تلميح", tr: "İpucu göster", ur: "اشارہ دکھائیں" },
  "tarteelOffline.challengeActivated": { fr: "Mode compétition activé !", en: "Challenge mode activated!", nl: "Uitdagingsmodus geactiveerd!", ar: "تم تفعيل وضع التحدي!", tr: "Yarışma modu etkinleştirildi!", ur: "چیلنج موڈ فعال!" },
  "tarteelOffline.detailedAnalysis": { fr: "Analyse détaillée", en: "Detailed analysis", nl: "Gedetailleerde analyse", ar: "تحليل مفصل", tr: "Detaylı analiz", ur: "تفصیلی تجزیہ" },
  "tarteelOffline.expected": { fr: "Attendu", en: "Expected", nl: "Verwacht", ar: "المتوقع", tr: "Beklenen", ur: "متوقع" },
  "tarteelOffline.correctWords": { fr: "Corrects", en: "Correct", nl: "Correct", ar: "صحيح", tr: "Doğru", ur: "درست" },
  "tarteelOffline.errors": { fr: "Erreurs", en: "Errors", nl: "Fouten", ar: "أخطاء", tr: "Hatalar", ur: "غلطیاں" },
  "tarteelOffline.missing": { fr: "Oublis", en: "Missing", nl: "Ontbrekend", ar: "مفقود", tr: "Eksik", ur: "گمشدہ" },
  "tarteelOffline.suggestions": { fr: "Conseils", en: "Tips", nl: "Tips", ar: "نصائح", tr: "İpuçları", ur: "مشورے" },
  "tarteelOffline.nextVerse": { fr: "Verset suivant", en: "Next verse", nl: "Volgend vers", ar: "الآية التالية", tr: "Sonraki ayet", ur: "اگلی آیت" },
  "tarteelOffline.excellentMastery": { fr: "Maîtrise excellente !", en: "Excellent mastery!", nl: "Uitstekende beheersing!", ar: "إتقان ممتاز!", tr: "Mükemmel ustalık!", ur: "بہترین مہارت!" },
  "tarteelOffline.veryGood": { fr: "Très bien !", en: "Very good!", nl: "Heel goed!", ar: "جيد جداً!", tr: "Çok iyi!", ur: "بہت اچھا!" },
  "tarteelOffline.tipPerfect": { fr: "Parfait ! Continue ta révision quotidienne.", en: "Perfect! Keep up your daily review.", nl: "Perfect! Ga door met je dagelijkse herhaling.", ar: "ممتاز! واصل مراجعتك اليومية.", tr: "Mükemmel! Günlük tekrarına devam et.", ur: "بہترین! روزانہ مراجعہ جاری رکھیں۔" },
  "tarteelOffline.tipSlow": { fr: "Ralentis légèrement ta récitation.", en: "Slow down your recitation slightly.", nl: "Vertraag je recitatie een beetje.", ar: "أبطئ قليلاً في تلاوتك.", tr: "Okumayı biraz yavaşlat.", ur: "تلاوت کو تھوڑا آہستہ کریں۔" },
  "tarteelOffline.tipEmphatic": { fr: "Accentue les lettres emphatiques (ص، ض، ط، ظ).", en: "Emphasize emphatic letters (ص، ض، ط، ظ).", nl: "Benadruk emfatische letters (ص، ض، ط، ظ).", ar: "أكّد على الحروف المفخمة (ص، ض، ط، ظ).", tr: "Vurgulu harflere dikkat et (ص، ض، ط، ظ).", ur: "تاکیدی حروف پر زور دیں (ص، ض، ط، ظ)۔" },
  "tarteelOffline.tipListen": { fr: "Écoute attentivement un récitateur expert.", en: "Listen carefully to an expert reciter.", nl: "Luister aandachtig naar een ervaren reciteerder.", ar: "استمع بعناية لقارئ متقن.", tr: "Uzman bir okuyucuyu dikkatle dinle.", ur: "ماہر قاری کو غور سے سنیں۔" },
  "tarteelOffline.tipRepeat": { fr: "Répète les passages difficiles 5 fois.", en: "Repeat difficult passages 5 times.", nl: "Herhaal moeilijke passages 5 keer.", ar: "كرّر المقاطع الصعبة 5 مرات.", tr: "Zor bölümleri 5 kez tekrarla.", ur: "مشکل حصوں کو 5 بار دہرائیں۔" },
  "tarteelOffline.tipTajweed": { fr: "Vérifie les règles de tajweed pour ce verset.", en: "Check tajweed rules for this verse.", nl: "Controleer tajweed-regels voor dit vers.", ar: "راجع أحكام التجويد لهذه الآية.", tr: "Bu ayet için tecvid kurallarını kontrol et.", ur: "اس آیت کے تجوید کے قواعد چیک کریں۔" },
  ...
  // ═══ KIDS PRAYER TRACKER ═══
  "kidsPrayerTracker.title": { fr: "Prières du jour", en: "Today's Prayers", nl: "Gebeden vandaag", ar: "صلوات اليوم", tr: "Bugünün Namazları", ur: "آج کی نمازیں" },
  "kidsPrayerTracker.validated": { fr: "Prière validée !", en: "Prayer done!", nl: "Gebed gedaan!", ar: "تمت الصلاة!", tr: "Namaz kılındı!", ur: "نماز ادا!" },
  "kidsPrayerTracker.allDone": { fr: "Toutes les prières faites ! Mashallah !", en: "All prayers done! Mashallah!", nl: "Alle gebeden gedaan! Mashallah!", ar: "كل الصلوات أُديت! ما شاء الله!", tr: "Tüm namazlar kılındı! Maşallah!", ur: "سب نمازیں ادا! ماشاءاللہ!" },
  ...
  // Badges / Achievements
  "badges.galleryTitle": { fr: "Galerie des Trophées", en: "Trophy Gallery", nl: "Trofeeëngalerij", ar: "معرض الجوائز", tr: "Kupa Galerisi", ur: "ٹرافی گیلری" },
  "badges.unlocked": { fr: "débloqués", en: "unlocked", nl: "ontgrendeld", ar: "مفتوحة", tr: "açıldı", ur: "کھلے" },
  "badges.noChild": { fr: "Sélectionnez un enfant", en: "Select a child", nl: "Selecteer een kind", ar: "اختر طفلاً", tr: "Bir çocuk seçin", ur: "ایک بچہ منتخب کریں" },
  "badges.selectChild": { fr: "Choisir un enfant", en: "Choose a child", nl: "Kies een kind", ar: "اختر طفلاً", tr: "Çocuk seç", ur: "بچہ چنیں" },
  "badges.share": { fr: "Partager mes trophées", en: "Share my trophies", nl: "Deel mijn trofeeën", ar: "شارك جوائزي", tr: "Kupalarımı paylaş", ur: "میری ٹرافیاں شیئر کریں" },
  "badges.legendary": { fr: "Légendaire", en: "Legendary", nl: "Legendarisch", ar: "أسطوري", tr: "Efsanevi", ur: "لیجنڈری" },
  "badges.gold": { fr: "Or", en: "Gold", nl: "Goud", ar: "ذهبي", tr: "Altın", ur: "سونا" },
  "badges.silver": { fr: "Argent", en: "Silver", nl: "Zilver", ar: "فضي", tr: "Gümüş", ur: "چاندی" },
  "badges.bronze": { fr: "Bronze", en: "Bronze", nl: "Brons", ar: "برونزي", tr: "Bronz", ur: "کانسی" },
  "badges.hifzBronze": { fr: "Hifz Bronze", en: "Hifz Bronze", nl: "Hifz Brons", ar: "حفظ برونزي", tr: "Hıfz Bronz", ur: "حفظ کانسی" },
  "badges.hifzSilver": { fr: "Hifz Argent", en: "Hifz Silver", nl: "Hifz Zilver", ar: "حفظ فضي", tr: "Hıfz Gümüş", ur: "حفظ چاندی" },
  "badges.hifzGold": { fr: "Hifz Or", en: "Hifz Gold", nl: "Hifz Goud", ar: "حفظ ذهبي", tr: "Hıfz Altın", ur: "حفظ سونا" },
  "badges.hifzLegend": { fr: "Hifz Légende", en: "Hifz Legend", nl: "Hifz Legende", ar: "حفظ أسطوري", tr: "Hıfz Efsane", ur: "حفظ لیجنڈ" },
  "badges.quizBronze": { fr: "Quiz Débutant", en: "Quiz Beginner", nl: "Quiz Beginner", ar: "اختبار مبتدئ", tr: "Quiz Başlangıç", ur: "کوئز ابتدائی" },
  "badges.quizSilver": { fr: "Quiz Expert", en: "Quiz Expert", nl: "Quiz Expert", ar: "خبير الاختبارات", tr: "Quiz Uzman", ur: "کوئز ماہر" },
  "badges.quizMaster": { fr: "Maître Quiz", en: "Quiz Master", nl: "Quiz Meester", ar: "سيد الاختبارات", tr: "Quiz Ustası", ur: "کوئز ماسٹر" },
  "badges.streak7": { fr: "Flamme 7j", en: "7-Day Streak", nl: "7-Dagen Streak", ar: "سلسلة 7 أيام", tr: "7 Gün Serisi", ur: "7 دن کا سلسلہ" },
  "badges.streak30": { fr: "Flamme 30j", en: "30-Day Streak", nl: "30-Dagen Streak", ar: "سلسلة 30 يوم", tr: "30 Gün Serisi", ur: "30 دن کا سلسلہ" },
  "badges.streak100": { fr: "Étoile 100j", en: "100-Day Star", nl: "100-Dagen Ster", ar: "نجمة 100 يوم", tr: "100 Gün Yıldızı", ur: "100 دن کا ستارہ" },
  "badges.tarteelStart": { fr: "Tarteel Début", en: "Tarteel Start", nl: "Tarteel Start", ar: "بداية الترتيل", tr: "Tertil Başla", ur: "ترتیل شروع" },
  "badges.tarteelPro": { fr: "Tarteel Pro", en: "Tarteel Pro", nl: "Tarteel Pro", ar: "ترتيل محترف", tr: "Tertil Pro", ur: "ترتیل پرو" },
  "badges.readingStart": { fr: "Lecture Début", en: "Reading Start", nl: "Lezen Start", ar: "بداية القراءة", tr: "Okuma Başla", ur: "پڑھنا شروع" },
  "badges.readingMarathon": { fr: "Marathon Lecture", en: "Reading Marathon", nl: "Leesmarathon", ar: "ماراثون القراءة", tr: "Okuma Maratonu", ur: "پڑھنے کا میراتھن" },
  "badges.prayerWeek": { fr: "Prière Semaine", en: "Prayer Week", nl: "Gebed Week", ar: "أسبوع الصلاة", tr: "Namaz Haftası", ur: "نماز ہفتہ" },
  "badges.prayerMonth": { fr: "Prière Mois", en: "Prayer Month", nl: "Gebed Maand", ar: "شهر الصلاة", tr: "Namaz Ayı", ur: "نماز مہینہ" },
  "badges.ramadan10": { fr: "Ramadan 10j", en: "Ramadan 10d", nl: "Ramadan 10d", ar: "رمضان 10 أيام", tr: "Ramazan 10g", ur: "رمضان 10 دن" },
  ...
  "mathGames.mathMemory": { fr: "Math Memory", en: "Math Memory", nl: "Math Memory", ar: "ذاكرة الرياضيات", tr: "Matematik Hafıza", ur: "ریاضی میموری" },
  "mathGames.mathMemoryDesc": { fr: "Trouve les paires calcul ↔ résultat !", en: "Find the calculation ↔ answer pairs!", nl: "Vind de berekening ↔ antwoord paren!", ar: "ابحث عن أزواج الحساب ↔ الإجابة!", tr: "Hesap ↔ cevap eşlerini bul!", ur: "حساب ↔ جواب کے جوڑے تلاش کریں!" },
  "mathGames.pairs": { fr: "paires", en: "pairs", nl: "paren", ar: "أزواج", tr: "çift", ur: "جوڑے" },
  "mathGames.moves": { fr: "coups", en: "moves", nl: "zetten", ar: "حركات", tr: "hamle", ur: "چالیں" },
  ...
  "mathGames.mathBomb": { fr: "Math Bomb", en: "Math Bomb", nl: "Math Bomb", ar: "قنبلة الرياضيات", tr: "Matematik Bombası", ur: "ریاضی بم" },
  "mathGames.mathBombDesc": { fr: "Désamorce la bombe en résolvant les calculs avant l'explosion !", en: "Defuse the bomb by solving calculations before it explodes!", nl: "Onschadelijk de bom door berekeningen op te lossen!", ar: "أبطل القنبلة بحل الحسابات قبل الانفجار!", tr: "Patlama öncesi hesapları çözerek bombayı etkisiz hale getir!", ur: "دھماکے سے پہلے حساب حل کر کے بم ناکارہ کرو!" },
  "mathGames.bombDefused": { fr: "Bombe désamorcée !", en: "Bomb defused!", nl: "Bom onschadelijk gemaakt!", ar: "تم إبطال القنبلة!", tr: "Bomba etkisiz!", ur: "بم ناکارہ!" },
  "mathGames.exploded": { fr: "BOOM ! La bombe a explosé !", en: "BOOM! The bomb exploded!", nl: "BOOM! De bom is ontploft!", ar: "بوم! انفجرت القنبلة!", tr: "BUM! Bomba patladı!", ur: "بوم! بم پھٹ گیا!" },
  "mathGames.calculations": { fr: "calculs", en: "calculations", nl: "berekeningen", ar: "حسابات", tr: "hesaplar", ur: "حسابات" },
  ...
  "dictation.fullSurah": { fr: "Sourate complète", en: "Full Surah", ar: "السورة كاملة", nl: "Volledige Soera", tr: "Tam Sûre", ur: "مکمل سورت" },
  "dictation.verses": { fr: "versets", en: "verses", ar: "آيات", nl: "verzen", tr: "ayet", ur: "آیات" },
  "dictation.blocks": { fr: "blocs", en: "blocks", ar: "أقسام", nl: "blokken", tr: "blok", ur: "حصے" },
  "dictation.blockSplit": { fr: "Cette sourate est découpée en", en: "This surah is split into", ar: "هذه السورة مقسمة إلى", nl: "Deze soera is verdeeld in", tr: "Bu sûre şu kadar bloğa ayrılmıştır:", ur: "یہ سورت تقسیم ہے" },
  "dictation.blocksOf": { fr: "blocs de dictée", en: "dictation blocks", ar: "أقسام إملاء", nl: "dictatieblokken", tr: "dikte bloğu", ur: "ڈکٹیشن حصے" },
  "dictation.block": { fr: "Bloc", en: "Block", ar: "قسم", nl: "Blok", tr: "Blok", ur: "حصہ" },
  "dictation.start": { fr: "Commencer", en: "Start", ar: "ابدأ", nl: "Starten", tr: "Başla", ur: "شروع کریں" },
  "dictation.readListenMemorise": { fr: "Lis, écoute et mémorise", en: "Read, listen & memorize", ar: "اقرأ، استمع واحفظ", nl: "Lees, luister en onthoud", tr: "Oku, dinle ve ezberle", ur: "پڑھیں، سنیں اور یاد کریں" },
  "dictation.readListenDesc": { fr: "Écoute et lis ces versets. Quand tu es prêt, lance la dictée de mémoire.", en: "Listen and read these verses. When ready, start the dictation from memory.", ar: "استمع واقرأ هذه الآيات. عندما تكون جاهزاً، ابدأ الإملاء من الذاكرة.", nl: "Luister en lees deze verzen. Begin de dictatie als je klaar bent.", tr: "Bu ayetleri dinle ve oku. Hazır olunca ezberden diktiye başla.", ur: "ان آیات کو سنیں اور پڑھیں۔ تیار ہونے پر حافظے سے لکھائی شروع کریں۔" },
  "dictation.readListenDescSingle": { fr: "ce verset", en: "this verse", ar: "هذه الآية", nl: "dit vers", tr: "bu ayet", ur: "یہ آیت" },
  "dictation.readListenDescMulti": { fr: "ces versets", en: "these verses", ar: "هذه الآيات", nl: "deze verzen", tr: "bu ayetler", ur: "یہ آیات" },
  "dictation.stopListening": { fr: "Arrêter", en: "Stop", ar: "إيقاف", nl: "Stoppen", tr: "Durdur", ur: "رکیں" },
  "dictation.listenAll": { fr: "Tout écouter", en: "Listen all", ar: "استمع الكل", nl: "Alles beluisteren", tr: "Hepsini dinle", ur: "سب سنیں" },
  "dictation.tapToListen": { fr: "Touche un verset pour l'écouter individuellement", en: "Tap a verse to listen individually", ar: "اضغط على آية للاستماع إليها", nl: "Tik op een vers om apart te luisteren", tr: "Tek tek dinlemek için ayete dokun", ur: "انفرادی طور پر سننے کے لیے آیت پر ٹیپ کریں" },
  "dictation.hardMode": { fr: "Mode Hard", en: "Hard Mode", ar: "الوضع الصعب", nl: "Moeilijke modus", tr: "Zor Mod", ur: "مشکل موڈ" },
  "dictation.hardModeDesc": { fr: "Récitation continue, correction à la fin", en: "Continuous recitation, correction at the end", ar: "تلاوة متواصلة، التصحيح في النهاية", nl: "Doorlopende recitatie, correctie aan het einde", tr: "Kesintisiz okuma, sonunda düzeltme", ur: "مسلسل تلاوت، آخر میں تصحیح" },
  "dictation.startDictation": { fr: "Commencer la dictée", en: "Start dictation", ar: "ابدأ الإملاء", nl: "Dictatie starten", tr: "Dikteye başla", ur: "ڈکٹیشن شروع کریں" },
  "dictation.textHiddenHint": { fr: "Le texte sera masqué et tu réciteras de mémoire", en: "Text will be hidden and you'll recite from memory", ar: "سيُخفى النص وستتلو من الذاكرة", nl: "Tekst wordt verborgen en je reciteert uit het hoofd", tr: "Metin gizlenecek ve ezberden okuyacaksın", ur: "متن چھپایا جائے گا اور آپ حافظے سے پڑھیں گے" },
  "dictation.textHiddenHintHard": { fr: "Récite tout le bloc sans interruption", en: "Recite the whole block without interruption", ar: "اتلُ القسم كاملاً بدون توقف", nl: "Reciteer het hele blok zonder onderbreking", tr: "Tüm bloğu kesintisiz oku", ur: "پورا حصہ بغیر رکے پڑھیں" },
  "dictation.reciteBlock": { fr: "Récite le bloc", en: "Recite the block", ar: "اتلُ القسم", nl: "Reciteer het blok", tr: "Bloğu oku", ur: "حصہ پڑھیں" },
  "dictation.verse": { fr: "verset", en: "verse", ar: "آية", nl: "vers", tr: "ayet", ur: "آیت" },
  "dictation.loading": { fr: "Chargement...", en: "Loading...", ar: "جارٍ التحميل...", nl: "Laden...", tr: "Yükleniyor...", ur: "لوڈ ہو رہا ہے..." },
  "dictation.listeningAyah": { fr: "Écoute Ayah", en: "Listening Ayah", ar: "استماع الآية", nl: "Luisteren Ayah", tr: "Ayet dinleniyor", ur: "آیت سن رہے ہیں" },
  "dictation.stop": { fr: "Arrêter", en: "Stop", ar: "إيقاف", nl: "Stoppen", tr: "Durdur", ur: "رکیں" },
  "dictation.micDenied": { fr: "Microphone refusé", en: "Microphone denied", ar: "الميكروفون مرفوض", nl: "Microfoon geweigerd", tr: "Mikrofon reddedildi", ur: "مائیکروفون رد کر دیا" },
  "dictation.micDeniedDesc": { fr: "Autorise l'accès micro dans les réglages du navigateur.", en: "Allow microphone access in browser settings.", ar: "فعّل إذن الميكروفون من إعدادات المتصفح.", nl: "Sta microfoon toe in de browserinstellingen.", tr: "Tarayıcı ayarlarından mikrofon erişimine izin ver.", ur: "براؤزر سیٹنگز میں مائیکروفون کی اجازت دیں۔" },
  "dictation.excellent": { fr: "Excellent ! Macha Allah !", en: "Excellent! Masha Allah!", ar: "ممتاز! ماشاء الله!", nl: "Uitstekend! Masha Allah!", tr: "Mükemmel! Maşallah!", ur: "بہترین! ماشاء اللہ!" },
  "dictation.veryGood": { fr: "Très bien", en: "Very good", ar: "جيد جداً", nl: "Heel goed", tr: "Çok iyi", ur: "بہت اچھا" },
  "dictation.correct": { fr: "correct", en: "correct", ar: "صحيح", nl: "correct", tr: "doğru", ur: "درست" },
  "dictation.continue": { fr: "Continue !", en: "Keep going!", ar: "واصل!", nl: "Ga door!", tr: "Devam et!", ur: "جاری رکھیں!" },
  "dictation.relistenVerse": { fr: "Réécouter le verset", en: "Listen again", ar: "أعد الاستماع", nl: "Opnieuw beluisteren", tr: "Tekrar dinle", ur: "دوبارہ سنیں" },
  "dictation.retry": { fr: "Réessayer", en: "Retry", ar: "إعادة المحاولة", nl: "Opnieuw proberen", tr: "Tekrar dene", ur: "دوبارہ کوشش" },
  "dictation.nextVerse": { fr: "Verset suivant", en: "Next verse", ar: "الآية التالية", nl: "Volgend vers", tr: "Sonraki ayet", ur: "اگلی آیت" },
  "dictation.blockSummary": { fr: "Résumé du bloc", en: "Block summary", ar: "ملخص القسم", nl: "Blokoverzicht", tr: "Blok özeti", ur: "حصے کا خلاصہ" },
  "dictation.dictationDone": { fr: "Dictée terminée !", en: "Dictation complete!", ar: "اكتمل الإملاء!", nl: "Dictatie voltooid!", tr: "Dikte tamamlandı!", ur: "ڈکٹیشن مکمل!" },
  "dictation.blockDone": { fr: "terminé !", en: "completed!", ar: "اكتمل!", nl: "voltooid!", tr: "tamamlandı!", ur: "مکمل!" },
  "dictation.redo": { fr: "Refaire", en: "Redo", ar: "إعادة", nl: "Opnieuw", tr: "Tekrarla", ur: "دوبارہ" },
  "dictation.nextBlock": { fr: "Bloc suivant", en: "Next block", ar: "القسم التالي", nl: "Volgend blok", tr: "Sonraki blok", ur: "اگلا حصہ" },
  "dictation.finalSummary": { fr: "Résumé final", en: "Final summary", ar: "الملخص النهائي", nl: "Eindoverzicht", tr: "Son özet", ur: "حتمی خلاصہ" },
  "dictation.surahDone": { fr: "Sourate terminée !", en: "Surah complete!", ar: "اكتملت السورة!", nl: "Soera voltooid!", tr: "Sûre tamamlandı!", ur: "سورت مکمل!" },
  "dictation.restart": { fr: "Recommencer", en: "Restart", ar: "إعادة البدء", nl: "Opnieuw beginnen", tr: "Yeniden başla", ur: "دوبارہ شروع" },
  "dictation.nextSurah": { fr: "Sourate suivante", en: "Next Surah", ar: "السورة التالية", nl: "Volgende Soera", tr: "Sonraki Sûre", ur: "اگلی سورت" },
  "dictation.back": { fr: "Retour", en: "Back", ar: "رجوع", nl: "Terug", tr: "Geri", ur: "واپس" },
  "dictation.viewBlocks": { fr: "Voir tous les blocs", en: "View all blocks", ar: "عرض جميع الأقسام", nl: "Alle blokken bekijken", tr: "Tüm blokları gör", ur: "تمام حصے دیکھیں" },
  "dictation.recitationAccuracy": { fr: "Exactitude récitation", en: "Recitation accuracy", ar: "دقة التلاوة", nl: "Nauwkeurigheid recitatie", tr: "Okuma doğruluğu", ur: "تلاوت کی درستگی" },
  "dictation.tajwidCorrect": { fr: "Tajwid correct", en: "Tajwid correct", ar: "تجويد صحيح", nl: "Tajwid correct", tr: "Tecvid doğru", ur: "تجوید درست" },
  "dictation.hardestAyahs": { fr: "Ayat les plus difficiles", en: "Hardest verses", ar: "أصعب الآيات", nl: "Moeilijkste verzen", tr: "En zor ayetler", ur: "مشکل ترین آیات" },
  "dictation.tajwidToReview": { fr: "Règles Tajwid à revoir", en: "Tajwid rules to review", ar: "قواعد التجويد للمراجعة", nl: "Tajwid-regels om te herzien", tr: "Tekrar edilecek Tecvid kuralları", ur: "نظرثانی کے لیے تجوید کے قواعد" },
  "dictation.tipsTitle": { fr: "Conseils pour s'améliorer", en: "Tips to improve", ar: "نصائح للتحسين", nl: "Tips om te verbeteren", tr: "Gelişim ipuçları", ur: "بہتری کے لیے تجاویز" },
  "dictation.tipSlower": { fr: "Essaie de réciter plus lentement en te concentrant sur chaque mot.", en: "Try reciting slower, focusing on each word.", ar: "حاول التلاوة ببطء مع التركيز على كل كلمة.", nl: "Probeer langzamer te reciteren, focus op elk woord.", tr: "Daha yavaş okumayı dene, her kelimeye odaklan.", ur: "ہر لفظ پر توجہ دے کر آہستہ پڑھنے کی کوشش کریں۔" },
  "dictation.tipGood": { fr: "Très bien ! Continue à pratiquer pour atteindre 90% et plus.", en: "Very good! Keep practicing to reach 90%+.", ar: "ممتاز! واصل التمرين للوصول إلى ٩٠٪ وأكثر.", nl: "Heel goed! Blijf oefenen voor 90%+.", tr: "Çok iyi! %90'ı geçmek için çalışmaya devam et.", ur: "بہت اچھا! 90%+ تک پہنچنے کے لیے مشق جاری رکھیں۔" },
  "dictation.tipRelistenModel": { fr: "Réécouter l'audio modèle pour l'Ayah", en: "Re-listen to the model audio for Ayah", ar: "أعد الاستماع للتلاوة النموذجية للآية", nl: "Herbeluister het modelaudio voor Ayah", tr: "Model sesi yeniden dinle, Ayet", ur: "آیت کے لیے نمونہ آڈیو دوبارہ سنیں" },
  "dictation.tipRelistenSuffix": { fr: "avant de refaire la dictée.", en: "before redoing dictation.", ar: "قبل إعادة الإملاء.", nl: "voordat je de dictatie opnieuw doet.", tr: "dikteyi yeniden yapmadan önce.", ur: "دوبارہ ڈکٹیشن سے پہلے۔" },
  "dictation.tipRuleError": { fr: "Revoir la règle", en: "Review the rule", ar: "راجع القاعدة", nl: "Herzie de regel", tr: "Kuralı gözden geçir", ur: "قاعدہ کا جائزہ لیں" },
  "dictation.errors": { fr: "erreur(s) détectée(s)", en: "error(s) detected", ar: "خطأ (أخطاء) مكتشفة", nl: "fout(en) gedetecteerd", tr: "hata tespit edildi", ur: "غلطی(اں) پائی گئیں" },
  "dictation.correctLabel": { fr: "Correct", en: "Correct", ar: "صحيح", nl: "Correct", tr: "Doğru", ur: "درست" },
  "dictation.errorLabel": { fr: "Erreur", en: "Error", ar: "خطأ", nl: "Fout", tr: "Hata", ur: "غلطی" },
  "dictation.missingLabel": { fr: "Manquant", en: "Missing", ar: "مفقود", nl: "Ontbrekend", tr: "Eksik", ur: "غائب" },
  "dictation.tajwidTip": { fr: "Conseil Tajwid", en: "Tajwid tip", ar: "نصيحة تجويد", nl: "Tajwid-tip", tr: "Tecvid ipucu", ur: "تجوید مشورہ" },
  "dictation.attentionTo": { fr: "Attention à", en: "Watch out for", ar: "انتبه لـ", nl: "Let op", tr: "Dikkat et", ur: "دھیان دیں" },

  "recitation.tapToRecite": { fr: "Appuyez sur le micro — le texte disparaîtra", en: "Tap the mic — the text will disappear", ar: "اضغط على الميكروفون — سيختفي النص", nl: "Tik op de microfoon — de tekst verdwijnt", tr: "Mikrofona bas — metin kaybolacak", ur: "مائیک پر ٹیپ کریں — متن غائب ہو جائے گا" },
  "recitation.tapToReciteChild": { fr: "Appuie pour réciter !", en: "Tap to recite!", ar: "اضغط للتلاوة!", nl: "Tik om te reciteren!", tr: "Okumak için dokun!", ur: "تلاوت کے لیے ٹیپ کریں!" },
  "recitation.tapToRetry": { fr: "Appuyez pour recommencer", en: "Tap to retry", ar: "اضغط لإعادة المحاولة", nl: "Tik om opnieuw te proberen", tr: "Tekrar denemek için dokun", ur: "دوبارہ کوشش کے لیے ٹیپ کریں" },
  "recitation.serverMode": { fr: "Mode micro sécurisé actif", en: "Secure mic mode active", ar: "وضع الميكروفون الآمن نشط", nl: "Veilige microfoonmodus actief", tr: "Güvenli mikrofon modu aktif", ur: "محفوظ مائیک موڈ فعال" },
  "recitation.instantMode": { fr: "Mode micro instantané actif", en: "Instant mic mode active", ar: "وضع الميكروفون الفوري نشط", nl: "Directe microfoonmodus actief", tr: "Anlık mikrofon modu aktif", ur: "فوری مائیک موڈ فعال" },
  "recitation.validate": { fr: "Valider", en: "Validate", ar: "تأكيد", nl: "Bevestigen", tr: "Onayla", ur: "تصدیق" },
  "recitation.validateVerse": { fr: "Valider verset", en: "Validate verse", ar: "تأكيد الآية", nl: "Vers bevestigen", tr: "Ayeti onayla", ur: "آیت کی تصدیق" },
  "recitation.superChampion": { fr: "Super champion !", en: "Super champion!", ar: "بطل خارق!", nl: "Super kampioen!", tr: "Süper şampiyon!", ur: "سپر چیمپئن!" },
  "recitation.wellDone": { fr: "Bien joué !", en: "Well done!", ar: "أحسنت!", nl: "Goed gedaan!", tr: "Aferin!", ur: "شاباش!" },
  "recitation.tryAgainChild": { fr: "Réessaie !", en: "Try again!", ar: "حاول مرة أخرى!", nl: "Probeer opnieuw!", tr: "Tekrar dene!", ur: "دوبارہ کوشش کریں!" },
  "recitation.excellentScore": { fr: "Excellent !", en: "Excellent!", ar: "ممتاز!", nl: "Uitstekend!", tr: "Mükemmel!", ur: "بہترین!" },
  "recitation.goodKeepGoing": { fr: "Bien, continuez", en: "Good, keep going", ar: "جيد، واصل", nl: "Goed, ga door", tr: "İyi, devam et", ur: "اچھا، جاری رکھیں" },
  "recitation.retryScore": { fr: "Réessayez", en: "Try again", ar: "أعد المحاولة", nl: "Probeer opnieuw", tr: "Tekrar dene", ur: "دوبارہ کوشش کریں" },
  "recitation.relistenVerse": { fr: "Réécouter ce verset", en: "Listen to this verse again", ar: "أعد الاستماع لهذه الآية", nl: "Luister dit vers opnieuw", tr: "Bu ayeti tekrar dinle", ur: "یہ آیت دوبارہ سنیں" },
  "recitation.verseNum": { fr: "Verset", en: "Verse", ar: "آية", nl: "Vers", tr: "Ayet", ur: "آیت" },
  ...
  "hifz.passages": { fr: "passages", en: "passages", ar: "مقاطع", nl: "passages", tr: "bölüm", ur: "حصے" },
  "hifz.surahLabel": { fr: "Sourate", en: "Surah", ar: "سورة", nl: "Soera", tr: "Sûre", ur: "سورت" },

  "recitation.hafiz": { fr: "Hâfiz en herbe", en: "Budding Hafiz", ar: "حافظ ناشئ", nl: "Aankomend Hafiz", tr: "Gelecek Hafız", ur: "ابھرتا حافظ" },
  "recitation.assiduous": { fr: "Récitateur assidu", en: "Dedicated reciter", ar: "قارئ مجتهد", nl: "Toegewijde recitator", tr: "Azimli okuyucu", ur: "محنتی قاری" },
  "recitation.inProgress": { fr: "En progression", en: "In progress", ar: "في تقدم", nl: "Bezig met vooruitgang", tr: "İlerlemede", ur: "ترقی میں" },

  "settings.noChallenge": { fr: "Aucun défi disponible", en: "No challenge available", ar: "لا يوجد تحدٍّ متاح", nl: "Geen uitdaging beschikbaar", tr: "Mevcut meydan okuma yok", ur: "کوئی چیلنج دستیاب نہیں" },

  "seo.more": { fr: "Plus - Paramètres & Outils", en: "More - Settings & Tools", ar: "المزيد - الإعدادات والأدوات", nl: "Meer - Instellingen & Tools", tr: "Daha Fazla - Ayarlar & Araçlar", ur: "مزید - ترتیبات اور ٹولز" },
  "seo.moreDesc": { fr: "Accédez aux paramètres, outils islamiques, prières, calendrier hijri et plus encore.", en: "Access settings, Islamic tools, prayers, Hijri calendar and more.", ar: "الوصول إلى الإعدادات والأدوات الإسلامية والصلوات والتقويم الهجري والمزيد.", nl: "Toegang tot instellingen, islamitische tools, gebeden, Hijri-kalender en meer.", tr: "Ayarlara, İslami araçlara, namazlara, Hicri takvime ve daha fazlasına erişin.", ur: "ترتیبات، اسلامی ٹولز، نمازیں، ہجری کیلنڈر اور مزید تک رسائی حاصل کریں۔" },
  "seo.moods": { fr: "États du Cœur - Moods & Athkâr", en: "Heart States - Moods & Athkar", ar: "حالات القلب - أحوال وأذكار", nl: "Harttoestanden - Stemmingen & Athkar", tr: "Kalp Halleri - Ruh Halleri & Ezkar", ur: "دل کی حالتیں - موڈز اور اذکار" },
  "seo.moodsDesc": { fr: "Trouvez la paix intérieure avec des invocations, remèdes spirituels et athkâr du Coran et de la Sunnah.", en: "Find inner peace with invocations, spiritual remedies and athkar from the Quran and Sunnah.", ar: "اعثر على السكينة مع الأدعية والعلاجات الروحية والأذكار من القرآن والسنة.", nl: "Vind innerlijke vrede met smeekbeden, spirituele remedies en athkar uit de Koran en Soenna.", tr: "Kur'an ve Sünnet'ten dualar, manevi çareler ve ezkarla iç huzuru bulun.", ur: "قرآن و سنت کی دعاؤں، روحانی علاج اور اذکار سے اندرونی سکون حاصل کریں۔" },
  "seo.asma": { fr: "99 Noms d'Allah - Asma ul Husna", en: "99 Names of Allah - Asma ul Husna", ar: "أسماء الله الحسنى الـ٩٩", nl: "99 Namen van Allah - Asma ul Husna", tr: "Allah'ın 99 İsmi - Esmaül Hüsna", ur: "اللہ کے 99 نام - اسماء الحسنیٰ" },
  "seo.asmaDesc": { fr: "Apprenez les 99 Noms d'Allah avec audio, arabe, phonétique et traduction.", en: "Learn the 99 Names of Allah with audio, Arabic, phonetics and translation.", ar: "تعلم أسماء الله الحسنى الـ٩٩ مع الصوت والعربية والنطق والترجمة.", nl: "Leer de 99 namen van Allah met audio, Arabisch, fonetiek en vertaling.", tr: "99 İsmi sesli, Arapça, fonetik ve çeviri ile öğrenin.", ur: "آڈیو، عربی، صوتیات اور ترجمے کے ساتھ اللہ کے 99 نام سیکھیں۔" },
} as const;
