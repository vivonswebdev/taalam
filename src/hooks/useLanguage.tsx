...
const translations = {
  ...
  "help.qWhatIsTaaloum": { fr: "Qu'est-ce que Taaloum ?", en: "What is Taaloum?", nl: "Wat is Taaloum?", ar: "ما هو تعلّم؟", tr: "Taaloum nedir?", ur: "تعلّم کیا ہے؟" },
  "help.aWhatIsTaaloum": { fr: "Taaloum est une application pour apprendre le Coran au quotidien : récitation avec IA, mémorisation (Hifz), quiz, habitudes et suivi de progression. Elle peut être utilisée seul(e), en famille ou avec un enseignant.", en: "Taaloum is an app for learning the Quran daily: AI-assisted recitation, memorization (Hifz), quizzes, habits and progress tracking. It can be used alone, with family or with a teacher.", nl: "Taaloum is een app om dagelijks de Koran te leren: recitatie met AI, memorisatie (Hifz), quizzen, gewoonten en voortgangsopvolging. Te gebruiken alleen, met familie of met een docent.", ar: "تعلّم هو تطبيق لتعلم القرآن يومياً: تلاوة بالذكاء الاصطناعي، حفظ، اختبارات، عادات ومتابعة التقدم. يمكن استخدامه فردياً أو مع العائلة أو مع معلم.", tr: "Taaloum, günlük Kur'an öğrenimi için bir uygulamadır: YZ destekli tilavet, ezberleme (Hıfz), testler, alışkanlıklar ve ilerleme takibi. Tek başına, aile ile veya öğretmenle kullanılabilir.", ur: "تعلّم قرآن کی روزانہ تعلیم کے لیے ایک ایپ ہے: مصنوعی ذہانت سے تلاوت، حفظ، کوئز، عادات اور پیشرفت کی ٹریکنگ۔ اکیلے، خاندان یا استاد کے ساتھ استعمال کی جا سکتی ہے۔" },
  ...
  "help.qHabits": { fr: "Que sont les « habitudes » dans Taaloum ?", en: "What are 'habits' in Taaloum?", nl: "Wat zijn 'gewoonten' in Taaloum?", ar: "ما هي «العادات» في تعلّم؟", tr: "Taaloum'da 'alışkanlıklar' nedir?", ur: "تعلّم میں 'عادات' کیا ہیں؟" },
  ...
  "help.qDataSharing": { fr: "Est-ce que Taaloum partage mes données ?", en: "Does Taaloum share my data?", nl: "Deelt Taaloum mijn gegevens?", ar: "هل يشارك تعلّم بياناتي؟", tr: "Taaloum verilerimi paylaşıyor mu?", ur: "کیا تعلّم میرا ڈیٹا شیئر کرتا ہے؟" },
  ...
  "terms.purpose": { fr: "Taaloum fournit des outils d'apprentissage du Coran (lecture, mémorisation, quiz, classes et suivi de progression). L'app vient en complément d'un enseignement religieux et ne remplace pas l'avis d'un enseignant ou d'un savant.", en: "Taaloum provides Quran learning tools (reading, memorization, quizzes, classes and progress tracking). The app complements religious education and does not replace the advice of a teacher or scholar.", nl: "Taaloum biedt Koran-leermiddelen (lezen, memorisatie, quizzen, klassen en voortgangsopvolging). De app is een aanvulling op religieus onderwijs en vervangt het advies van een docent of geleerde niet.", ar: "يوفر تعلّم أدوات لتعلم القرآن (قراءة، حفظ، اختبارات، فصول ومتابعة التقدم). التطبيق مكمّل للتعليم الديني ولا يحل محل رأي معلم أو عالم.", tr: "Taaloum, Kur'an öğrenme araçları sunar (okuma, ezberleme, testler, sınıflar ve ilerleme takibi). Uygulama dini eğitimi tamamlar ve bir öğretmenin veya âlimin tavsiyesinin yerini almaz.", ur: "تعلّم قرآن سیکھنے کے اوزار فراہم کرتا ہے (پڑھنا، حفظ، کوئز، کلاسز اور پیشرفت کی ٹریکنگ)۔ ایپ مذہبی تعلیم کی تکمیل ہے اور استاد یا عالم کی رائے کا متبادل نہیں ہے۔" },
  ...
  "terms.data": { fr: "Nous stockons vos informations de profil et vos données d'apprentissage pour afficher vos statistiques et améliorer Taaloum. Pour les comptes rattachés à un professeur ou à un parent, certaines statistiques sont partagées avec eux. Vous pouvez demander la suppression de votre compte.", en: "We store your profile information and learning data to display your statistics and improve Taaloum. For accounts linked to a teacher or parent, some learning statistics are shared with them. You can request account deletion.", nl: "Wij bewaren je profielinformatie en leergegevens om je statistieken te tonen en Taaloum te verbeteren. Voor accounts gekoppeld aan een docent of ouder worden sommige leerstatistieken gedeeld. Je kunt verwijdering van je account aanvragen.", ar: "نخزّن معلومات ملفك الشخصي وبيانات التعلم لعرض إحصائياتك وتحسين تعلّم. للحسابات المرتبطة بمعلم أو والد، تُشارك بعض إحصائيات التعلم معهم. يمكنك طلب حذف حسابك.", tr: "Profilinizi ve öğrenme verilerinizi istatistiklerinizi göstermek ve Taaloum'u geliştirmek için saklıyoruz. Bir öğretmen veya ebeveyne bağlı hesaplarda bazı öğrenme istatistikleri onlarla paylaşılır. Hesap silme talebinde bulunabilirsiniz.", ur: "ہم آپ کی پروفائل معلومات اور سیکھنے کا ڈیٹا آپ کے اعدادوشمار دکھانے اور تعلّم کو بہتر بنانے کے لیے محفوظ کرتے ہیں۔ استاد یا والدین سے منسلک اکاؤنٹس کے لیے کچھ اعدادوشمار ان کے ساتھ شیئر کیے جاتے ہیں۔ آپ اکاؤنٹ حذف کرنے کی درخواست کر سکتے ہیں۔" },
  ...
  "terms.contact": { fr: "Pour toute question ou demande concernant vos données, vous pouvez nous contacter à l'adresse : support@taaloum.eu.", en: "For any questions or requests regarding your data, you can contact us at: support@taaloum.eu.", nl: "Voor vragen of verzoeken over je gegevens kun je contact opnemen via: support@taaloum.eu.", ar: "لأي أسئلة أو طلبات تتعلق ببياناتك، يمكنك التواصل معنا على: support@taaloum.eu.", tr: "Verilerinizle ilgili soru veya talepleriniz için bizimle iletişime geçebilirsiniz: support@taaloum.eu.", ur: "اپنے ڈیٹا سے متعلق کسی بھی سوال یا درخواست کے لیے ہم سے رابطہ کریں: support@taaloum.eu۔" },
  ...
  // Install App
  "install.title": { fr: "Installer Taaloum comme une app", en: "Install Taaloum as an app", nl: "Installeer Taaloum als app", ar: "تثبيت تعلّم كتطبيق", tr: "Taaloum'u uygulama olarak yükle", ur: "تعلّم کو ایپ کے طور پر انسٹال کریں" },
  "install.subtitle": { fr: "Ajoute Taaloum à ton écran d'accueil pour l'utiliser comme une vraie application.", en: "Add Taaloum to your home screen to use it like a real app.", nl: "Voeg Taaloum toe aan je startscherm om het als een echte app te gebruiken.", ar: "أضف تعلّم إلى شاشتك الرئيسية لاستخدامه كتطبيق حقيقي.", tr: "Taaloum'u gerçek bir uygulama gibi kullanmak için ana ekranına ekle.", ur: "تعلّم کو ایک حقیقی ایپ کی طرح استعمال کرنے کے لیے اپنی ہوم اسکرین میں شامل کریں۔" },
  ...
  "install.iosStep2": { fr: "Va sur l'adresse de Taaloum : https://taalam.eu/.", en: "Go to the Taaloum address: https://taalam.eu/.", nl: "Ga naar het Taaloum-adres: https://taalam.eu/.", ar: "اذهب إلى عنوان تعلّم: https://taalam.eu/.", tr: "Taaloum adresine git: https://taalam.eu/.", ur: "تعلّم کے پتے پر جائیں: https://taalam.eu/۔" },
  ...
  "install.iosStep5": { fr: "Vérifie le nom « Taaloum », puis touche « Ajouter ».", en: "Verify the name 'Taaloum', then tap 'Add'.", nl: "Controleer de naam 'Taaloum' en tik op 'Voeg toe'.", ar: "تأكد من الاسم «تعلّم»، ثم اضغط «إضافة».", tr: "'Taaloum' adını doğrula, sonra 'Ekle' düğmesine bas.", ur: "'تعلّم' نام کی تصدیق کریں، پھر 'شامل کریں' پر ٹیپ کریں۔" },
  "install.iosStep6": { fr: "L'icône Taaloum apparaît maintenant sur ton écran d'accueil comme une vraie app.", en: "The Taaloum icon now appears on your home screen like a real app.", nl: "Het Taaloum-icoon verschijnt nu op je startscherm als een echte app.", ar: "أيقونة تعلّم تظهر الآن على شاشتك الرئيسية كتطبيق حقيقي.", tr: "Taaloum simgesi artık ana ekranında gerçek bir uygulama gibi görünüyor.", ur: "تعلّم کا آئیکن اب آپ کی ہوم اسکرین پر ایک حقیقی ایپ کی طرح نظر آتا ہے۔" },
  ...
  "install.androidStep6": { fr: "L'icône Taaloum apparaît maintenant comme une app sur ton écran d'accueil.", en: "The Taaloum icon now appears as an app on your home screen.", nl: "Het Taaloum-icoon verschijnt nu als een app op je startscherm.", ar: "أيقونة تعلّم تظهر الآن كتطبيق على شاشتك الرئيسية.", tr: "Taaloum simgesi artık ana ekranında bir uygulama olarak görünüyor.", ur: "تعلّم کا آئیکن اب آپ کی ہوم اسکرین پر ایک ایپ کے طور پر نظر آتا ہے۔" },
  ...
  "install.desktopStep5": { fr: "Taaloum apparaîtra comme une application dans ton menu Démarrer ou Launchpad.", en: "Taaloum will appear as an app in your Start menu or Launchpad.", nl: "Taaloum verschijnt als een app in je Startmenu of Launchpad.", ar: "سيظهر تعلّم كتطبيق في قائمة ابدأ أو Launchpad.", tr: "Taaloum, Başlat menüsünde veya Launchpad'de bir uygulama olarak görünecek.", ur: "تعلّم آپ کے اسٹارٹ مینو یا لانچ پیڈ میں ایک ایپ کے طور پر ظاہر ہوگا۔" },
