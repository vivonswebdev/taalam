...
const translations = {
  ...
  // Parent / Teacher
  "parent.title": { fr: "Espace parent", en: "Parent area", nl: "Ouder sectie", ar: "مساحة الوالدين" },
  "parent.subtitle": { fr: "Gérez et suivez les progrès", en: "Manage & track progress", nl: "Beheer & volg voortgang", ar: "إدارة ومتابعة التقدم" },
  "parent.setPin": { fr: "Créer un code PIN", en: "Set a PIN", nl: "PIN instellen", ar: "إنشاء رمز PIN" },
  "parent.setPinDesc": { fr: "Choisissez un code à 4 chiffres", en: "Choose a 4-digit code", nl: "Kies een 4-cijferige code", ar: "اختر رمزاً من 4 أرقام" },
  "parent.enterPin": { fr: "Entrez votre PIN", en: "Enter your PIN", nl: "Voer je PIN in", ar: "أدخل رمز PIN" },
  "parent.enterPinDesc": { fr: "Code à 4 chiffres", en: "4-digit code", nl: "4-cijferige code", ar: "رمز من 4 أرقام" },
  "parent.createPin": { fr: "Accès protégé", en: "Protected access", nl: "Beveiligde toegang", ar: "وصول محمي" },
  "parent.createPinDesc": { fr: "Créez un PIN pour sécuriser cet espace", en: "Create a PIN to secure this area", nl: "Maak een PIN om deze sectie te beveiligen", ar: "أنشئ رمز PIN لتأمين هذه المنطقة" },
  "parent.wrongPin": { fr: "Code incorrect", en: "Wrong PIN", nl: "Verkeerde PIN", ar: "رمز خاطئ" },
  "parent.confirm": { fr: "Confirmer", en: "Confirm", nl: "Bevestigen", ar: "تأكيد" },
  "parent.unlock": { fr: "Déverrouiller", en: "Unlock", nl: "Ontgrendelen", ar: "فتح" },
  "parent.noChildren": { fr: "Aucun profil enfant", en: "No child profiles", nl: "Geen kinderprofielen", ar: "لا توجد ملفات أطفال" },
  "parent.addChild": { fr: "Ajouter un enfant", en: "Add a child", nl: "Kind toevoegen", ar: "إضافة طفل" },
  "parent.editChild": { fr: "Modifier le profil", en: "Edit profile", nl: "Profiel bewerken", ar: "تعديل الملف" },
  "parent.years": { fr: "ans", en: "years", nl: "jaar", ar: "سنة" },
  "parent.mastery": { fr: "Maîtrise", en: "Mastery", nl: "Beheersing", ar: "إتقان" },
  "parent.edit": { fr: "Modifier", en: "Edit", nl: "Bewerken", ar: "تعديل" },
  "parent.delete": { fr: "Supprimer", en: "Delete", nl: "Verwijderen", ar: "حذف" },
  "parent.save": { fr: "Enregistrer", en: "Save", nl: "Opslaan", ar: "حفظ" },
  "parent.add": { fr: "Ajouter", en: "Add", nl: "Toevoegen", ar: "إضافة" },
  "parent.namePlaceholder": { fr: "Prénom de l'enfant", en: "Child's name", nl: "Naam van het kind", ar: "اسم الطفل" },
  "parent.agePlaceholder": { fr: "Âge (optionnel)", en: "Age (optional)", nl: "Leeftijd (optioneel)", ar: "العمر (اختياري)" },
  "parent.deleteConfirmTitle": { fr: "Supprimer ce profil ?", en: "Delete this profile?", nl: "Dit profiel verwijderen?", ar: "حذف هذا الملف؟" },
  "parent.deleteConfirmMsg": { fr: "Toutes les données de cet enfant seront supprimées.", en: "All data for this child will be deleted.", nl: "Alle gegevens van dit kind worden verwijderd.", ar: "سيتم حذف جميع بيانات هذا الطفل." },
  "parent.childNotFound": { fr: "Profil introuvable", en: "Profile not found", nl: "Profiel niet gevonden", ar: "الملف غير موجود" },
  "parent.tabHifz": { fr: "Carte Hifz", en: "Hifz Map", nl: "Hifz Kaart", ar: "خريطة الحفظ" },
  "parent.tabHistory": { fr: "Historique", en: "History", nl: "Geschiedenis", ar: "السجل" },
  "parent.noSessions": { fr: "Aucune session enregistrée", en: "No sessions recorded", nl: "Geen sessies opgenomen", ar: "لا توجد جلسات مسجلة" },
  "parent.weeklyReport": { fr: "Rapport hebdomadaire", en: "Weekly report", nl: "Weekrapport", ar: "التقرير الأسبوعي" },
  "parent.thisWeek": { fr: "Cette semaine", en: "This week", nl: "Deze week", ar: "هذا الأسبوع" },
  "parent.avgScore": { fr: "Score moyen", en: "Avg score", nl: "Gem. score", ar: "متوسط النتيجة" },
  "parent.totalTime": { fr: "Temps total", en: "Total time", nl: "Totale tijd", ar: "الوقت الإجمالي" },
  "parent.progressVsAvg": { fr: "vs moyenne globale", en: "vs overall average", nl: "vs totaal gemiddelde", ar: "مقارنة بالمعدل العام" },
  "parent.strongSurahs": { fr: "Sourates fortes", en: "Strong surahs", nl: "Sterke soera's", ar: "السور القوية" },
  "parent.weakSurahs": { fr: "Sourates à revoir", en: "Surahs to review", nl: "Te herzien soera's", ar: "سور تحتاج مراجعة" },
  "parent.passagesWorked": { fr: "Passages travaillés", en: "Passages worked", nl: "Bewerkte passages", ar: "المقاطع التي تم العمل عليها" },
  ...
  "classrooms.joinClass": { fr: "Rejoindre une classe", en: "Join a class", nl: "Klas bijtreden", ar: "الانضمام لفصل" },
  "classrooms.joinCodePlaceholder": { fr: "Code de la classe (ex: E9XUAR)", en: "Class code (e.g. E9XUAR)", nl: "Klascode (bv. E9XUAR)", ar: "رمز الفصل (مثال: E9XUAR)" },
  "classrooms.joinBtn": { fr: "Rejoindre", en: "Join", nl: "Bijtreden", ar: "انضمام" },
  "classrooms.joinSuccess": { fr: "Vous avez rejoint la classe", en: "You joined the class", nl: "Je bent toegetreden tot de klas", ar: "لقد انضممت إلى الفصل" },
  "classrooms.joinInvalidCode": { fr: "Code invalide", en: "Invalid code", nl: "Ongeldige code", ar: "رمز غير صالح" },
  "classrooms.joinAlreadyMember": { fr: "Vous êtes déjà membre", en: "You are already a member", nl: "Je bent al lid", ar: "أنت عضو بالفعل" },
  "classrooms.messages": { fr: "Messages du groupe", en: "Group Messages", nl: "Groepsberichten", ar: "رسائل المجموعة" },
  "classrooms.typeMessage": { fr: "Écrire un message...", en: "Type a message...", nl: "Schrijf een bericht...", ar: "اكتب رسالة..." },
  "classrooms.send": { fr: "Envoyer", en: "Send", nl: "Verzenden", ar: "إرسال" },
  "classrooms.noMessages": { fr: "Aucun message", en: "No messages yet", nl: "Nog geen berichten", ar: "لا توجد رسائل بعد" },
  // Join Classroom
