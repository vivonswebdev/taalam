...
const CATEGORIES: Category[] = [
  {
    ...
    emoji: "📖",
    features: [
      { id: "quran", nameKey: "dashboard.tarteel", emoji: "📖", path: "/quran", gradient: "from-blue-500 to-cyan-600" },
      { id: "reading", nameKey: "dashboard.reading", emoji: "📚", path: "/reading", gradient: "from-emerald-500 to-green-600" },
      { id: "mushaf", nameKey: "dashboard.mushaf", emoji: "📗", path: "/mushaf", gradient: "from-teal-500 to-emerald-600" },
      { id: "listening", nameKey: "dashboard.listening", emoji: "🎧", path: "/listening", gradient: "from-violet-500 to-purple-600" },
      { id: "tarteel", nameKey: "dashboard.tarteel", emoji: "🎤", path: "/tarteel", gradient: "from-orange-500 to-red-500" },
      { id: "liveQuran", nameKey: "home.cat.liveQuran", emoji: "🔴", path: "/live-quran", gradient: "from-red-500 to-rose-600" },
    ],
  },
  {
    id: "learning",
    ...
    emoji: "🎓",
    features: [
      { id: "quiz", nameKey: "dashboard.quiz", emoji: "🧠", path: "/quiz", gradient: "from-purple-500 to-violet-600" },
      { id: "hifzPlan", nameKey: "dashboard.hifzPlan", emoji: "🎯", path: "/hifz-plan", gradient: "from-rose-500 to-pink-600" },
      { id: "hifzMap", nameKey: "dashboard.hifzMap", emoji: "🗺️", path: "/hifz-map", gradient: "from-amber-500 to-orange-600" },
      { id: "noorani", nameKey: "dashboard.noorani", emoji: "📚", path: "/noorani", gradient: "from-indigo-500 to-blue-600" },
      { id: "study", nameKey: "home.cat.study", emoji: "✍️", path: "/study", gradient: "from-cyan-500 to-sky-600" },
      { id: "findAyah", nameKey: "dashboard.findAyah", emoji: "🔍", path: "/find-ayah", gradient: "from-lime-500 to-green-600" },
    ],
  },
  {
    id: "spiritual",
    ...
    emoji: "🕌",
    features: [
      { id: "moods", nameKey: "dashboard.moods", emoji: "💎", path: "/moods", gradient: "from-pink-500 to-rose-600" },
      { id: "habits", nameKey: "dashboard.habits", emoji: "✅", path: "/habits", gradient: "from-emerald-500 to-teal-600" },
      { id: "athkar", nameKey: "home.cat.athkar", emoji: "🤲", path: "/athkar/morning", gradient: "from-amber-400 to-orange-500" },
      { id: "qibla", nameKey: "dashboard.qibla", emoji: "🧭", path: "/qibla", gradient: "from-sky-500 to-blue-600" },
      { id: "zakat", nameKey: "dashboard.zakat", emoji: "💰", path: "/zakat", gradient: "from-green-500 to-emerald-600" },
      { id: "tasbih", nameKey: "dashboard.tasbih", emoji: "📿", path: "/tasbih", gradient: "from-purple-500 to-indigo-600" },
      { id: "calendar", nameKey: "dashboard.calendar", emoji: "🌙", path: "/islamic-calendar", gradient: "from-indigo-500 to-violet-600" },
      { id: "stories", nameKey: "dashboard.stories", emoji: "📜", path: "/kids-stories", gradient: "from-orange-400 to-amber-500" },
      { id: "mosques", nameKey: "dashboard.mosques", emoji: "🕌", path: "/kids-mosque-map", gradient: "from-teal-500 to-cyan-600" },
      { id: "liveHaramain", nameKey: "dashboard.liveHaramain", emoji: "🕋", path: "/live-haramain", gradient: "from-rose-600 to-red-600" },
    ],
  },
  {
    id: "social",
    ...
    emoji: "👥",
    features: [
      { id: "kids", nameKey: "dashboard.kids", emoji: "👨‍👩‍👧", path: "/kids", gradient: "from-fuchsia-500 to-pink-600" },
      { id: "classrooms", nameKey: "dashboard.classrooms", emoji: "🏫", path: "/classrooms", gradient: "from-blue-500 to-indigo-600" },
      { id: "teacher", nameKey: "dashboard.teacher", emoji: "👨‍🏫", path: "/teacher-dashboard", gradient: "from-violet-500 to-purple-600" },
      { id: "community", nameKey: "dashboard.community", emoji: "🌍", path: "/community", gradient: "from-emerald-500 to-green-600" },
      { id: "leaderboard", nameKey: "dashboard.leaderboard", emoji: "🏆", path: "/leaderboard", gradient: "from-yellow-400 to-amber-500" },
    ],
  },
  {
    id: "progress",
    ...
    emoji: "📊",
    features: [
      { id: "progress", nameKey: "dashboard.progress", emoji: "📊", path: "/progress", gradient: "from-cyan-500 to-blue-600" },
      { id: "hifzToday", nameKey: "home.cat.hifzToday", emoji: "📅", path: "/hifz-today", gradient: "from-orange-500 to-red-500" },
      { id: "bookmarks", nameKey: "dashboard.bookmarks", emoji: "🔖", path: "/bookmarks", gradient: "from-rose-500 to-pink-600" },
      { id: "perfectLb", nameKey: "home.cat.perfectLb", emoji: "⭐", path: "/perfect-leaderboard", gradient: "from-yellow-400 to-amber-500" },
    ],
  },
  {
    id: "settings",
    ...
    emoji: "⚙️",
    features: [
      { id: "theme", nameKey: "dashboard.theme", emoji: "🎨", action: "theme", gradient: "from-violet-500 to-fuchsia-600" },
      { id: "reciter", nameKey: "dashboard.reciter", emoji: "🔊", action: "reciter", gradient: "from-sky-500 to-cyan-600" },
      { id: "athan", nameKey: "dashboard.athan", emoji: "⏰", path: "/athan-settings", gradient: "from-amber-500 to-orange-600" },
      { id: "notifs", nameKey: "dashboard.notifs", emoji: "🔔", path: "/notification-settings", gradient: "from-yellow-400 to-amber-500" },
      { id: "languages", nameKey: "dashboard.languages", emoji: "🌍", action: "language", gradient: "from-emerald-500 to-teal-600" },
      { id: "offline", nameKey: "dashboard.offline", emoji: "📱", path: "/offline-settings", gradient: "from-blue-500 to-indigo-600" },
      { id: "profile", nameKey: "dashboard.profile", emoji: "👤", path: "/settings", gradient: "from-slate-500 to-gray-600" },
      { id: "games", nameKey: "dashboard.games", emoji: "🎮", path: "/jeux", gradient: "from-purple-500 to-pink-600" },
      { id: "donate", nameKey: "dashboard.donate", emoji: "❤️", action: "donate", gradient: "from-red-500 to-rose-600" },
      { id: "faq", nameKey: "dashboard.faq", emoji: "❓", path: "/faq", gradient: "from-teal-500 to-cyan-600" },
    ],
  },
];
