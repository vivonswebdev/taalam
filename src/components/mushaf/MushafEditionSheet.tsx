...
export const MUSHAF_EDITIONS: MushafEdition[] = [
  {
    ...
    description: "Le plus répandu — calligraphie Uthmani, 15 lignes, 604 pages.",
    style: "Hafs · Tajwid coloré",
    icon: "📕",
    imageBaseUrl: "https://cdn.islamic.network/quran/images/page",
    totalPages: 604,
  ...
  },
  {
    ...
    labelAr: "مصحف الهند وباكستان",
    description: "Style sud-asiatique — calligraphie Naskh ornementée.",
    style: "Hafs · Naskh ornementé",
    icon: "📗",
    imageBaseUrl: "https://www.searchtruth.org/quran/images2/",
    totalPages: 604,
