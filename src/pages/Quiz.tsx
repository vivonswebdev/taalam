...
export default function Quiz() {
  ...
  if (finished) {
    ...
    const level = finalScore <= 2 ? "Débutant" : finalScore <= 4 ? "Intermédiaire" : "Avancé";
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <motion.button
          ...
          className="mt-8 bg-primary text-primary-foreground rounded-2xl px-8 py-4 font-semibold active:scale-[0.98] transition-transform"
        >
              ...
              {question.options.map((option, idx) => {
                ...
                return (
                  <motion.button
                    ...
                    className={`w-full flex items-center gap-3 p-4 rounded-2xl border-2 transition-all text-left font-medium ${style}`}
                  >
