...
function getEveryAyahFolder(reciterId: string): string {
  const map: Record<string, string> = {
    ...
    'ar.kalbani': 'Khaalid_Abdullaah_al-Qahtaanee_192kbps',
    'ar.harraz': 'Ibrahim_Akhdar_32kbps',
    'ar.qazabri': 'Nasser_Alqatami_128kbps',
    'ar.tablawi': 'Mohammad_al_Tablaway_128kbps',
    'ar.basfar': 'Abdullah_Basfar_192kbps',
    'ar.budair': 'Salah_Al_Budair_128kbps',
    'ar.jibreen': 'Abdullaah_3awwaad_Al-Juhaynee_128kbps',
