...
export default function MathShooterPage() {
  ...
  if (!difficulty || gameState === "menu") {
    return <DifficultySelector title={t("mathGames.mathShooter" as any) || "Math Shooter"} icon="🚀" onSelect={selectDifficulty} onBack={() => navigate(-1)} t={(k) => t(k as any)} difficulties={[
